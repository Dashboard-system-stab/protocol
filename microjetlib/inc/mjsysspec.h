...
static const char mj_bro30_gen_date[] = { 0x32,0x33,0x2d,0x30,0x39,0x2d,0x32,0x36,0x00 };
...
#endif
#ifndef BUP_INTERNAL_MCAST_IP
#define BUP_INTERNAL_MCAST_IP (0x10bc8ef) // bup_internal_mcast 239.200.11.1
#endif
...
#endif
#ifndef AUFD_IP
#define AUFD_IP (0x1008a8c0) // 192.168.8.16
#endif
#ifndef BUP_DCU_LFD_IP
#define BUP_DCU_LFD_IP (0xb08a8c0) // 192.168.8.11
#endif
#ifndef BUP_DCU_RFD_IP
#define BUP_DCU_RFD_IP (0xa08a8c0) // 192.168.8.10
#endif
#ifndef BUP_DCU_LRD_IP
#define BUP_DCU_LRD_IP (0xd08a8c0) // 192.168.8.13
#endif
#ifndef BUP_DCU_RRD_IP
#define BUP_DCU_RRD_IP (0xc08a8c0) // 192.168.8.12
#endif
#ifndef BUP_DCU_LST_IP
#define BUP_DCU_LST_IP (0xf08a8c0) // 192.168.8.15
#endif
#ifndef BUP_DCU_RST_IP
#define BUP_DCU_RST_IP (0xe08a8c0) // 192.168.8.14
#endif
#ifndef MON_IP
#define MON_IP (0xc908a8c0) // 192.168.8.201
#endif
#ifndef IM_BRO_IP
...
typedef enum bro30_msg_id
{
	...
	ID_DCU_TEL = 0x73C1,
	ID_BUP_STATE = 0x824,
	ID_DRIVE_SLAVE_FB = 0xA987,
	ID_DRIVE_MASTER_CTRL = 0xFA80,
	ID_BUP_CTRL = 0xD994,
...
typedef enum bro30_prm_id
{
     ...
     PRM_FLOAT_OHP_HYST = ((int)0xB67F1E8),
     ...
     PRM_FLOAT_LOAD_SPEED_FLT_FC = ((int)0x47B4E0EE),
     PRM_FLOAT_ROTOR_SPEED_FLT_FC = ((int)0xE4CCE479),
     ...
     PRM_FLOAT_LOAD_SPEED_INT_LIM = ((int)0xB815CE97),
     PRM_FLOAT_LOAD_SPEED_OUT_RATE_LIM = ((int)0x4608CFD6),
     PRM_FLOAT_LOAD_SPEED_ERR_RATE_LIM = ((int)0x697055A4),
     PRM_BOOL_LOAD_ANG_REV = ((int)0x96EC79E6),
     PRM_FLOAT_LOAD_ANG_KP = ((int)0x380A69BE),
     PRM_FLOAT_LOAD_ANG_KI = ((int)0x1C9C8B96),
     PRM_FLOAT_LOAD_ANG_KB = ((int)0x8A30CBEA),
     PRM_FLOAT_LOAD_ANG_KT = ((int)0xA768C0A5),
     PRM_FLOAT_LOAD_ANG_KF = ((int)0x155262F1),
     PRM_FLOAT_LOAD_ANG_KD = ((int)0xDAE373A7),
     PRM_FLOAT_LOAD_ANG_ERR_LIM = ((int)0x15AB5439),
     PRM_FLOAT_LOAD_ANG_OUT_LIM = ((int)0x5277826D),
     PRM_FLOAT_LOAD_ANG_OUT_RATE_LIM = ((int)0xC6B60F77),
     PRM_FLOAT_LOAD_ANG_ERR_RATE_LIM = ((int)0xE9CE9505),
     PRM_FLOAT_LOAD_ANG_DZ = ((int)0x665CAA19),
     PRM_BOOL_LOAD_ANG_DZ_EN = ((int)0x69B9B702),
     ...
     PRM_FLOAT_ROTOR_SPEED_INT_LIM = ((int)0xC044682E),
     PRM_FLOAT_ROTOR_SPEED_OUT_RATE_LIM = ((int)0x86EE36E2),
     PRM_FLOAT_ROTOR_SPEED_ERR_RATE_LIM = ((int)0xA996AC90),
     PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KP = ((int)0xE4BC057D),
     PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KI = ((int)0xC02AE755),
     PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KB = ((int)0x5686A729),
     PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KT = ((int)0x7BDEAC66),
     PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KF = ((int)0xC9E40E32),
     PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_ERR_LIM = ((int)0x2073EC66),
     PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_OUT_LIM = ((int)0x67AF3A32),
     PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_INT_LIM = ((int)0x4261C897),
     PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_OUT_RATE_LIM = ((int)0x53169F2D),
     PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_ERR_RATE_LIM = ((int)0x7C6E055F),
     PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KP = ((int)0x56EE8F6),
     PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KI = ((int)0x21F80ADE),
     PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KB = ((int)0xB7544AA2),
     PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KT = ((int)0x9A0C41ED),
     PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KF = ((int)0x2836E3B9),
     PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_ERR_LIM = ((int)0xC995954D),
     PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_OUT_LIM = ((int)0x8E494319),
     PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_INT_LIM = ((int)0xAB87B1BC),
     PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_OUT_RATE_LIM = ((int)0xE37276C4),
     PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_ERR_RATE_LIM = ((int)0xCC0AECB6),
     PRM_INT_ROTOR_SPEED_ROLE = ((int)0xE8701AA),
     ...
     PRM_FLOAT_ROTOR_ANG_DZ = ((int)0x7121BD4C),
     PRM_BOOL_ROTOR_ANG_DZ_EN = ((int)0x7EC4A057),
     ...
     PRM_STRING_COM_IF_BUP_INTERNAL_MCAST = ((int)0x5BF96276),

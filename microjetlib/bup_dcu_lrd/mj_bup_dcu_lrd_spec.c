...
static uint16_t self_dev_id = BRO30_BUP_DCU_LRD;

static mj_bup_dcu_lrd_t mj_handle;
...
static bup_dcu_lrd_prm_t _bup_dcu_lrd_prm;

mj_prm_status_t bup_dcu_lrd_prm_write(int id, void *data)
{
    switch (id){
        case PRM_BOOL_SERVICE_MODE:
            memcpy(&(_bup_dcu_lrd_prm.service_mode),data,sizeof(_bup_dcu_lrd_prm.service_mode));
            return MJ_PRM_OK;
        case PRM_BOOL_DBG_MODE:
            memcpy(&(_bup_dcu_lrd_prm.dbg_mode),data,sizeof(_bup_dcu_lrd_prm.dbg_mode));
            return MJ_PRM_OK;
        case PRM_BOOL_PTP_STAT:
            memcpy(&(_bup_dcu_lrd_prm.ptp_stat),data,sizeof(_bup_dcu_lrd_prm.ptp_stat));
            return MJ_PRM_OK;
        case PRM_FLOAT_VDC_SCALE:
            memcpy(&(_bup_dcu_lrd_prm.vdc_scale),data,sizeof(_bup_dcu_lrd_prm.vdc_scale));
            return MJ_PRM_OK;
        case PRM_FLOAT_OCP_LVL:
            memcpy(&(_bup_dcu_lrd_prm.ocp_lvl),data,sizeof(_bup_dcu_lrd_prm.ocp_lvl));
            return MJ_PRM_OK;
        case PRM_FLOAT_CUR_LIM:
            memcpy(&(_bup_dcu_lrd_prm.cur_lim),data,sizeof(_bup_dcu_lrd_prm.cur_lim));
            return MJ_PRM_OK;
        case PRM_BOOL_DRV_ANG_REVERSE:
            memcpy(&(_bup_dcu_lrd_prm.drv_ang_reverse),data,sizeof(_bup_dcu_lrd_prm.drv_ang_reverse));
            return MJ_PRM_OK;
        case PRM_BOOL_DRV_CURRENT_REVERSE:
            memcpy(&(_bup_dcu_lrd_prm.drv_current_reverse),data,sizeof(_bup_dcu_lrd_prm.drv_current_reverse));
            return MJ_PRM_OK;
        case PRM_BOOL_DRV_VOLTAGE_REVERSE:
            memcpy(&(_bup_dcu_lrd_prm.drv_voltage_reverse),data,sizeof(_bup_dcu_lrd_prm.drv_voltage_reverse));
            return MJ_PRM_OK;
        case PRM_FLOAT_DRV_ZERO:
            memcpy(&(_bup_dcu_lrd_prm.drv_zero),data,sizeof(_bup_dcu_lrd_prm.drv_zero));
            return MJ_PRM_OK;
        case PRM_FLOAT_VDC_MIN:
            memcpy(&(_bup_dcu_lrd_prm.vdc_min),data,sizeof(_bup_dcu_lrd_prm.vdc_min));
            return MJ_PRM_OK;
        case PRM_BOOL_IM_MODE:
            memcpy(&(_bup_dcu_lrd_prm.im_mode),data,sizeof(_bup_dcu_lrd_prm.im_mode));
            return MJ_PRM_OK;
        case PRM_FLOAT_PTP_KP:
            memcpy(&(_bup_dcu_lrd_prm.ptp_kp),data,sizeof(_bup_dcu_lrd_prm.ptp_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_PTP_KI:
            memcpy(&(_bup_dcu_lrd_prm.ptp_ki),data,sizeof(_bup_dcu_lrd_prm.ptp_ki));
            return MJ_PRM_OK;
        case PRM_FLOAT_PTP_KD:
            memcpy(&(_bup_dcu_lrd_prm.ptp_kd),data,sizeof(_bup_dcu_lrd_prm.ptp_kd));
            return MJ_PRM_OK;
        case PRM_FLOAT_OHP_LVL:
            memcpy(&(_bup_dcu_lrd_prm.ohp_lvl),data,sizeof(_bup_dcu_lrd_prm.ohp_lvl));
            return MJ_PRM_OK;
        case PRM_FLOAT_OHP_HYST:
            memcpy(&(_bup_dcu_lrd_prm.ohp_hyst),data,sizeof(_bup_dcu_lrd_prm.ohp_hyst));
            return MJ_PRM_OK;
        case PRM_FLOAT_EL_ZERO:
            memcpy(&(_bup_dcu_lrd_prm.el_zero),data,sizeof(_bup_dcu_lrd_prm.el_zero));
            return MJ_PRM_OK;
        case PRM_INT_POLE_PAIRS:
            memcpy(&(_bup_dcu_lrd_prm.pole_pairs),data,sizeof(_bup_dcu_lrd_prm.pole_pairs));
            return MJ_PRM_OK;
        case PRM_FLOAT_PH_RESISTANCE:
            memcpy(&(_bup_dcu_lrd_prm.ph_resistance),data,sizeof(_bup_dcu_lrd_prm.ph_resistance));
            return MJ_PRM_OK;
        case PRM_FLOAT_PH_INDUCTANCE:
            memcpy(&(_bup_dcu_lrd_prm.ph_inductance),data,sizeof(_bup_dcu_lrd_prm.ph_inductance));
            return MJ_PRM_OK;
        case PRM_FLOAT_BRAKE_UNLOCK_VOLTAGE:
            memcpy(&(_bup_dcu_lrd_prm.brake_unlock_voltage),data,sizeof(_bup_dcu_lrd_prm.brake_unlock_voltage));
            return MJ_PRM_OK;
        case PRM_INT_BRAKE_UNLOCK_TIME:
            memcpy(&(_bup_dcu_lrd_prm.brake_unlock_time),data,sizeof(_bup_dcu_lrd_prm.brake_unlock_time));
            return MJ_PRM_OK;
        case PRM_FLOAT_BRAKE_HOLD_VOLTAGE:
            memcpy(&(_bup_dcu_lrd_prm.brake_hold_voltage),data,sizeof(_bup_dcu_lrd_prm.brake_hold_voltage));
            return MJ_PRM_OK;
        case PRM_INT_BRAKE_LOCK_TIME:
            memcpy(&(_bup_dcu_lrd_prm.brake_lock_time),data,sizeof(_bup_dcu_lrd_prm.brake_lock_time));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_KP:
            memcpy(&(_bup_dcu_lrd_prm.curr_kp),data,sizeof(_bup_dcu_lrd_prm.curr_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_KI:
            memcpy(&(_bup_dcu_lrd_prm.curr_ki),data,sizeof(_bup_dcu_lrd_prm.curr_ki));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_KB:
            memcpy(&(_bup_dcu_lrd_prm.curr_kb),data,sizeof(_bup_dcu_lrd_prm.curr_kb));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_KT:
            memcpy(&(_bup_dcu_lrd_prm.curr_kt),data,sizeof(_bup_dcu_lrd_prm.curr_kt));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_KF:
            memcpy(&(_bup_dcu_lrd_prm.curr_kf),data,sizeof(_bup_dcu_lrd_prm.curr_kf));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_FC:
            memcpy(&(_bup_dcu_lrd_prm.curr_fc),data,sizeof(_bup_dcu_lrd_prm.curr_fc));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_ERR_LIM:
            memcpy(&(_bup_dcu_lrd_prm.curr_err_lim),data,sizeof(_bup_dcu_lrd_prm.curr_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_OUT_LIM:
            memcpy(&(_bup_dcu_lrd_prm.curr_out_lim),data,sizeof(_bup_dcu_lrd_prm.curr_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_OUT_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.curr_out_rate_lim),data,sizeof(_bup_dcu_lrd_prm.curr_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_ERR_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.curr_err_rate_lim),data,sizeof(_bup_dcu_lrd_prm.curr_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_KP:
            memcpy(&(_bup_dcu_lrd_prm.load_speed_kp),data,sizeof(_bup_dcu_lrd_prm.load_speed_kp));
            return MJ_PRM_OK;
        ...
        case PRM_FLOAT_LOAD_SPEED_KF:
            memcpy(&(_bup_dcu_lrd_prm.load_speed_kf),data,sizeof(_bup_dcu_lrd_prm.load_speed_kf));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_ERR_LIM:
            memcpy(&(_bup_dcu_lrd_prm.load_speed_err_lim),data,sizeof(_bup_dcu_lrd_prm.load_speed_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_OUT_LIM:
            memcpy(&(_bup_dcu_lrd_prm.load_speed_out_lim),data,sizeof(_bup_dcu_lrd_prm.load_speed_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_INT_LIM:
            memcpy(&(_bup_dcu_lrd_prm.load_speed_int_lim),data,sizeof(_bup_dcu_lrd_prm.load_speed_int_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_OUT_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.load_speed_out_rate_lim),data,sizeof(_bup_dcu_lrd_prm.load_speed_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_ERR_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.load_speed_err_rate_lim),data,sizeof(_bup_dcu_lrd_prm.load_speed_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_FLT_FC:
            memcpy(&(_bup_dcu_lrd_prm.load_speed_flt_fc),data,sizeof(_bup_dcu_lrd_prm.load_speed_flt_fc));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_FLT_FC:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_flt_fc),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_flt_fc));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_KP:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_kp),data,sizeof(_bup_dcu_lrd_prm.load_ang_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_KI:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_ki),data,sizeof(_bup_dcu_lrd_prm.load_ang_ki));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_KB:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_kb),data,sizeof(_bup_dcu_lrd_prm.load_ang_kb));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_KT:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_kt),data,sizeof(_bup_dcu_lrd_prm.load_ang_kt));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_KF:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_kf),data,sizeof(_bup_dcu_lrd_prm.load_ang_kf));
            return MJ_PRM_OK;
        case PRM_BOOL_LOAD_ANG_REV:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_rev),data,sizeof(_bup_dcu_lrd_prm.load_ang_rev));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_KD:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_kd),data,sizeof(_bup_dcu_lrd_prm.load_ang_kd));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_ERR_LIM:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_err_lim),data,sizeof(_bup_dcu_lrd_prm.load_ang_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_OUT_LIM:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_out_lim),data,sizeof(_bup_dcu_lrd_prm.load_ang_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_OUT_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_out_rate_lim),data,sizeof(_bup_dcu_lrd_prm.load_ang_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_ERR_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_err_rate_lim),data,sizeof(_bup_dcu_lrd_prm.load_ang_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_DZ:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_dz),data,sizeof(_bup_dcu_lrd_prm.load_ang_dz));
            return MJ_PRM_OK;
        case PRM_BOOL_LOAD_ANG_DZ_EN:
            memcpy(&(_bup_dcu_lrd_prm.load_ang_dz_en),data,sizeof(_bup_dcu_lrd_prm.load_ang_dz_en));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_KP:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_kp),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_kp));
            return MJ_PRM_OK;
        ...
        case PRM_FLOAT_ROTOR_SPEED_KF:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_kf),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_kf));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_ERR_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_err_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_OUT_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_out_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_INT_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_int_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_int_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_OUT_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_out_rate_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_ERR_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_err_rate_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KP:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_common_kp),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KI:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_common_ki),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_ki));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KB:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_common_kb),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_kb));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KT:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_common_kt),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_kt));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KF:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_common_kf),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_kf));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_ERR_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_common_err_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_OUT_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_common_out_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_INT_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_common_int_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_int_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_OUT_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_common_out_rate_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_ERR_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_common_err_rate_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KP:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_diff_kp),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KI:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_diff_ki),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_ki));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KB:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_diff_kb),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_kb));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KT:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_diff_kt),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_kt));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KF:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_diff_kf),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_kf));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_ERR_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_diff_err_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_OUT_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_diff_out_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_INT_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_diff_int_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_int_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_OUT_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_diff_out_rate_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_ERR_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_master_diff_err_rate_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_INT_ROTOR_SPEED_ROLE:
            memcpy(&(_bup_dcu_lrd_prm.rotor_speed_role),data,sizeof(_bup_dcu_lrd_prm.rotor_speed_role));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_KP:
            memcpy(&(_bup_dcu_lrd_prm.rotor_ang_kp),data,sizeof(_bup_dcu_lrd_prm.rotor_ang_kp));
            return MJ_PRM_OK;
        ...
        case PRM_FLOAT_ROTOR_ANG_KF:
            memcpy(&(_bup_dcu_lrd_prm.rotor_ang_kf),data,sizeof(_bup_dcu_lrd_prm.rotor_ang_kf));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_ERR_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_ang_err_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_ang_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_OUT_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_ang_out_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_ang_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_OUT_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_ang_out_rate_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_ang_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_ERR_RATE_LIM:
            memcpy(&(_bup_dcu_lrd_prm.rotor_ang_err_rate_lim),data,sizeof(_bup_dcu_lrd_prm.rotor_ang_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_DZ:
            memcpy(&(_bup_dcu_lrd_prm.rotor_ang_dz),data,sizeof(_bup_dcu_lrd_prm.rotor_ang_dz));
            return MJ_PRM_OK;
        case PRM_BOOL_ROTOR_ANG_DZ_EN:
            memcpy(&(_bup_dcu_lrd_prm.rotor_ang_dz_en),data,sizeof(_bup_dcu_lrd_prm.rotor_ang_dz_en));
            return MJ_PRM_OK;
        case PRM_STRING_FACTORY_DATE:
            memcpy(&(_bup_dcu_lrd_prm.factory_date),data,sizeof(_bup_dcu_lrd_prm.factory_date));
            return MJ_PRM_OK;
        case PRM_STRING_FACTORY_NUMBER:
            memcpy(&(_bup_dcu_lrd_prm.factory_number),data,sizeof(_bup_dcu_lrd_prm.factory_number));
            return MJ_PRM_OK;
        case PRM_STRING_DESCRIPTION:
            memcpy(&(_bup_dcu_lrd_prm.description),data,sizeof(_bup_dcu_lrd_prm.description));
            return MJ_PRM_OK;
        case PRM_INT_DEV_ID:
            memcpy(&(_bup_dcu_lrd_prm.dev_id),data,sizeof(_bup_dcu_lrd_prm.dev_id));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_SRV_MCAST_REQ:
            memcpy(&(_bup_dcu_lrd_prm.com_if_srv_mcast_req),data,sizeof(_bup_dcu_lrd_prm.com_if_srv_mcast_req));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_SRV_MCAST_ANS:
            memcpy(&(_bup_dcu_lrd_prm.com_if_srv_mcast_ans),data,sizeof(_bup_dcu_lrd_prm.com_if_srv_mcast_ans));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_BRO_BUP_CTRL_MCAST:
            memcpy(&(_bup_dcu_lrd_prm.com_if_bro_bup_ctrl_mcast),data,sizeof(_bup_dcu_lrd_prm.com_if_bro_bup_ctrl_mcast));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_BRO_BUP_DATA_MCAST:
            memcpy(&(_bup_dcu_lrd_prm.com_if_bro_bup_data_mcast),data,sizeof(_bup_dcu_lrd_prm.com_if_bro_bup_data_mcast));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_BUP_INTERNAL_MCAST:
            memcpy(&(_bup_dcu_lrd_prm.com_if_bup_internal_mcast),data,sizeof(_bup_dcu_lrd_prm.com_if_bup_internal_mcast));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_BRO_BUP_SRV_MCAST:
            memcpy(&(_bup_dcu_lrd_prm.com_if_bro_bup_srv_mcast),data,sizeof(_bup_dcu_lrd_prm.com_if_bro_bup_srv_mcast));
            return MJ_PRM_OK;
...
mj_prm_status_t bup_dcu_lrd_prm_read(int id, void *data)
{
    switch (id){
        case PRM_BOOL_SERVICE_MODE:
            memcpy(data,&_bup_dcu_lrd_prm.service_mode,sizeof(_bup_dcu_lrd_prm.service_mode));
            return MJ_PRM_OK;
        case PRM_BOOL_DBG_MODE:
            memcpy(data,&_bup_dcu_lrd_prm.dbg_mode,sizeof(_bup_dcu_lrd_prm.dbg_mode));
            return MJ_PRM_OK;
        case PRM_BOOL_PTP_STAT:
            memcpy(data,&_bup_dcu_lrd_prm.ptp_stat,sizeof(_bup_dcu_lrd_prm.ptp_stat));
            return MJ_PRM_OK;
        case PRM_FLOAT_VDC_SCALE:
            memcpy(data,&_bup_dcu_lrd_prm.vdc_scale,sizeof(_bup_dcu_lrd_prm.vdc_scale));
            return MJ_PRM_OK;
        case PRM_FLOAT_OCP_LVL:
            memcpy(data,&_bup_dcu_lrd_prm.ocp_lvl,sizeof(_bup_dcu_lrd_prm.ocp_lvl));
            return MJ_PRM_OK;
        case PRM_FLOAT_CUR_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.cur_lim,sizeof(_bup_dcu_lrd_prm.cur_lim));
            return MJ_PRM_OK;
        case PRM_BOOL_DRV_ANG_REVERSE:
            memcpy(data,&_bup_dcu_lrd_prm.drv_ang_reverse,sizeof(_bup_dcu_lrd_prm.drv_ang_reverse));
            return MJ_PRM_OK;
        case PRM_BOOL_DRV_CURRENT_REVERSE:
            memcpy(data,&_bup_dcu_lrd_prm.drv_current_reverse,sizeof(_bup_dcu_lrd_prm.drv_current_reverse));
            return MJ_PRM_OK;
        case PRM_BOOL_DRV_VOLTAGE_REVERSE:
            memcpy(data,&_bup_dcu_lrd_prm.drv_voltage_reverse,sizeof(_bup_dcu_lrd_prm.drv_voltage_reverse));
            return MJ_PRM_OK;
        case PRM_FLOAT_DRV_ZERO:
            memcpy(data,&_bup_dcu_lrd_prm.drv_zero,sizeof(_bup_dcu_lrd_prm.drv_zero));
            return MJ_PRM_OK;
        case PRM_FLOAT_VDC_MIN:
            memcpy(data,&_bup_dcu_lrd_prm.vdc_min,sizeof(_bup_dcu_lrd_prm.vdc_min));
            return MJ_PRM_OK;
        case PRM_BOOL_IM_MODE:
            memcpy(data,&_bup_dcu_lrd_prm.im_mode,sizeof(_bup_dcu_lrd_prm.im_mode));
            return MJ_PRM_OK;
        case PRM_FLOAT_PTP_KP:
            memcpy(data,&_bup_dcu_lrd_prm.ptp_kp,sizeof(_bup_dcu_lrd_prm.ptp_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_PTP_KI:
            memcpy(data,&_bup_dcu_lrd_prm.ptp_ki,sizeof(_bup_dcu_lrd_prm.ptp_ki));
            return MJ_PRM_OK;
        case PRM_FLOAT_PTP_KD:
            memcpy(data,&_bup_dcu_lrd_prm.ptp_kd,sizeof(_bup_dcu_lrd_prm.ptp_kd));
            return MJ_PRM_OK;
        case PRM_FLOAT_OHP_LVL:
            memcpy(data,&_bup_dcu_lrd_prm.ohp_lvl,sizeof(_bup_dcu_lrd_prm.ohp_lvl));
            return MJ_PRM_OK;
        case PRM_FLOAT_OHP_HYST:
            memcpy(data,&_bup_dcu_lrd_prm.ohp_hyst,sizeof(_bup_dcu_lrd_prm.ohp_hyst));
            return MJ_PRM_OK;
        case PRM_FLOAT_EL_ZERO:
            memcpy(data,&_bup_dcu_lrd_prm.el_zero,sizeof(_bup_dcu_lrd_prm.el_zero));
            return MJ_PRM_OK;
        case PRM_INT_POLE_PAIRS:
            memcpy(data,&_bup_dcu_lrd_prm.pole_pairs,sizeof(_bup_dcu_lrd_prm.pole_pairs));
            return MJ_PRM_OK;
        case PRM_FLOAT_PH_RESISTANCE:
            memcpy(data,&_bup_dcu_lrd_prm.ph_resistance,sizeof(_bup_dcu_lrd_prm.ph_resistance));
            return MJ_PRM_OK;
        case PRM_FLOAT_PH_INDUCTANCE:
            memcpy(data,&_bup_dcu_lrd_prm.ph_inductance,sizeof(_bup_dcu_lrd_prm.ph_inductance));
            return MJ_PRM_OK;
        case PRM_FLOAT_BRAKE_UNLOCK_VOLTAGE:
            memcpy(data,&_bup_dcu_lrd_prm.brake_unlock_voltage,sizeof(_bup_dcu_lrd_prm.brake_unlock_voltage));
            return MJ_PRM_OK;
        case PRM_INT_BRAKE_UNLOCK_TIME:
            memcpy(data,&_bup_dcu_lrd_prm.brake_unlock_time,sizeof(_bup_dcu_lrd_prm.brake_unlock_time));
            return MJ_PRM_OK;
        case PRM_FLOAT_BRAKE_HOLD_VOLTAGE:
            memcpy(data,&_bup_dcu_lrd_prm.brake_hold_voltage,sizeof(_bup_dcu_lrd_prm.brake_hold_voltage));
            return MJ_PRM_OK;
        case PRM_INT_BRAKE_LOCK_TIME:
            memcpy(data,&_bup_dcu_lrd_prm.brake_lock_time,sizeof(_bup_dcu_lrd_prm.brake_lock_time));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_KP:
            memcpy(data,&_bup_dcu_lrd_prm.curr_kp,sizeof(_bup_dcu_lrd_prm.curr_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_KI:
            memcpy(data,&_bup_dcu_lrd_prm.curr_ki,sizeof(_bup_dcu_lrd_prm.curr_ki));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_KB:
            memcpy(data,&_bup_dcu_lrd_prm.curr_kb,sizeof(_bup_dcu_lrd_prm.curr_kb));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_KT:
            memcpy(data,&_bup_dcu_lrd_prm.curr_kt,sizeof(_bup_dcu_lrd_prm.curr_kt));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_KF:
            memcpy(data,&_bup_dcu_lrd_prm.curr_kf,sizeof(_bup_dcu_lrd_prm.curr_kf));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_FC:
            memcpy(data,&_bup_dcu_lrd_prm.curr_fc,sizeof(_bup_dcu_lrd_prm.curr_fc));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_ERR_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.curr_err_lim,sizeof(_bup_dcu_lrd_prm.curr_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_OUT_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.curr_out_lim,sizeof(_bup_dcu_lrd_prm.curr_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_OUT_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.curr_out_rate_lim,sizeof(_bup_dcu_lrd_prm.curr_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_CURR_ERR_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.curr_err_rate_lim,sizeof(_bup_dcu_lrd_prm.curr_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_KP:
            memcpy(data,&_bup_dcu_lrd_prm.load_speed_kp,sizeof(_bup_dcu_lrd_prm.load_speed_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_KI:
        ...
        case PRM_FLOAT_LOAD_SPEED_KT:
            ...
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_KF:
            memcpy(data,&_bup_dcu_lrd_prm.load_speed_kf,sizeof(_bup_dcu_lrd_prm.load_speed_kf));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_ERR_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.load_speed_err_lim,sizeof(_bup_dcu_lrd_prm.load_speed_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_OUT_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.load_speed_out_lim,sizeof(_bup_dcu_lrd_prm.load_speed_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_INT_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.load_speed_int_lim,sizeof(_bup_dcu_lrd_prm.load_speed_int_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_OUT_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.load_speed_out_rate_lim,sizeof(_bup_dcu_lrd_prm.load_speed_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_ERR_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.load_speed_err_rate_lim,sizeof(_bup_dcu_lrd_prm.load_speed_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_FLT_FC:
            memcpy(data,&_bup_dcu_lrd_prm.load_speed_flt_fc,sizeof(_bup_dcu_lrd_prm.load_speed_flt_fc));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_FLT_FC:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_flt_fc,sizeof(_bup_dcu_lrd_prm.rotor_speed_flt_fc));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_KP:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_kp,sizeof(_bup_dcu_lrd_prm.load_ang_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_KI:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_ki,sizeof(_bup_dcu_lrd_prm.load_ang_ki));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_KB:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_kb,sizeof(_bup_dcu_lrd_prm.load_ang_kb));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_KT:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_kt,sizeof(_bup_dcu_lrd_prm.load_ang_kt));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_KF:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_kf,sizeof(_bup_dcu_lrd_prm.load_ang_kf));
            return MJ_PRM_OK;
        case PRM_BOOL_LOAD_ANG_REV:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_rev,sizeof(_bup_dcu_lrd_prm.load_ang_rev));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_KD:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_kd,sizeof(_bup_dcu_lrd_prm.load_ang_kd));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_ERR_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_err_lim,sizeof(_bup_dcu_lrd_prm.load_ang_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_OUT_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_out_lim,sizeof(_bup_dcu_lrd_prm.load_ang_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_OUT_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_out_rate_lim,sizeof(_bup_dcu_lrd_prm.load_ang_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_ERR_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_err_rate_lim,sizeof(_bup_dcu_lrd_prm.load_ang_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_ANG_DZ:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_dz,sizeof(_bup_dcu_lrd_prm.load_ang_dz));
            return MJ_PRM_OK;
        case PRM_BOOL_LOAD_ANG_DZ_EN:
            memcpy(data,&_bup_dcu_lrd_prm.load_ang_dz_en,sizeof(_bup_dcu_lrd_prm.load_ang_dz_en));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_KP:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_kp,sizeof(_bup_dcu_lrd_prm.rotor_speed_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_KI:
        ...
        case PRM_FLOAT_ROTOR_SPEED_KT:
            ...
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_KF:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_kf,sizeof(_bup_dcu_lrd_prm.rotor_speed_kf));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_ERR_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_err_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_OUT_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_out_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_INT_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_int_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_int_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_OUT_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_out_rate_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_ERR_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_err_rate_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KP:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_common_kp,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KI:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_common_ki,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_ki));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KB:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_common_kb,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_kb));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KT:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_common_kt,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_kt));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_KF:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_common_kf,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_kf));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_ERR_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_common_err_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_OUT_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_common_out_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_INT_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_common_int_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_int_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_OUT_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_common_out_rate_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_COMMON_ERR_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_common_err_rate_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_common_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KP:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_diff_kp,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KI:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_diff_ki,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_ki));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KB:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_diff_kb,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_kb));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KT:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_diff_kt,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_kt));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_KF:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_diff_kf,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_kf));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_ERR_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_diff_err_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_OUT_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_diff_out_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_INT_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_diff_int_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_int_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_OUT_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_diff_out_rate_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_MASTER_DIFF_ERR_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_master_diff_err_rate_lim,sizeof(_bup_dcu_lrd_prm.rotor_speed_master_diff_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_INT_ROTOR_SPEED_ROLE:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_speed_role,sizeof(_bup_dcu_lrd_prm.rotor_speed_role));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_KP:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_ang_kp,sizeof(_bup_dcu_lrd_prm.rotor_ang_kp));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_KI:
        ...
        case PRM_FLOAT_ROTOR_ANG_KT:
            ...
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_KF:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_ang_kf,sizeof(_bup_dcu_lrd_prm.rotor_ang_kf));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_ERR_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_ang_err_lim,sizeof(_bup_dcu_lrd_prm.rotor_ang_err_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_OUT_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_ang_out_lim,sizeof(_bup_dcu_lrd_prm.rotor_ang_out_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_OUT_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_ang_out_rate_lim,sizeof(_bup_dcu_lrd_prm.rotor_ang_out_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_ERR_RATE_LIM:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_ang_err_rate_lim,sizeof(_bup_dcu_lrd_prm.rotor_ang_err_rate_lim));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_DZ:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_ang_dz,sizeof(_bup_dcu_lrd_prm.rotor_ang_dz));
            return MJ_PRM_OK;
        case PRM_BOOL_ROTOR_ANG_DZ_EN:
            memcpy(data,&_bup_dcu_lrd_prm.rotor_ang_dz_en,sizeof(_bup_dcu_lrd_prm.rotor_ang_dz_en));
            return MJ_PRM_OK;
        case PRM_STRING_FACTORY_DATE:
            memcpy(data,&_bup_dcu_lrd_prm.factory_date,sizeof(_bup_dcu_lrd_prm.factory_date));
            return MJ_PRM_OK;
        case PRM_STRING_FACTORY_NUMBER:
            memcpy(data,&_bup_dcu_lrd_prm.factory_number,sizeof(_bup_dcu_lrd_prm.factory_number));
            return MJ_PRM_OK;
        case PRM_STRING_DESCRIPTION:
            memcpy(data,&_bup_dcu_lrd_prm.description,sizeof(_bup_dcu_lrd_prm.description));
            return MJ_PRM_OK;
        case PRM_INT_DEV_ID:
            memcpy(data,&_bup_dcu_lrd_prm.dev_id,sizeof(_bup_dcu_lrd_prm.dev_id));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_SRV_MCAST_REQ:
            memcpy(data,&_bup_dcu_lrd_prm.com_if_srv_mcast_req,sizeof(_bup_dcu_lrd_prm.com_if_srv_mcast_req));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_SRV_MCAST_ANS:
            memcpy(data,&_bup_dcu_lrd_prm.com_if_srv_mcast_ans,sizeof(_bup_dcu_lrd_prm.com_if_srv_mcast_ans));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_BRO_BUP_CTRL_MCAST:
            memcpy(data,&_bup_dcu_lrd_prm.com_if_bro_bup_ctrl_mcast,sizeof(_bup_dcu_lrd_prm.com_if_bro_bup_ctrl_mcast));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_BRO_BUP_DATA_MCAST:
            memcpy(data,&_bup_dcu_lrd_prm.com_if_bro_bup_data_mcast,sizeof(_bup_dcu_lrd_prm.com_if_bro_bup_data_mcast));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_BUP_INTERNAL_MCAST:
            memcpy(data,&_bup_dcu_lrd_prm.com_if_bup_internal_mcast,sizeof(_bup_dcu_lrd_prm.com_if_bup_internal_mcast));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_BRO_BUP_SRV_MCAST:
            memcpy(data,&_bup_dcu_lrd_prm.com_if_bro_bup_srv_mcast,sizeof(_bup_dcu_lrd_prm.com_if_bro_bup_srv_mcast));
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_IM_BRO_DRIVE_MCAST:
...
static void loop_fcn()
{
    ...
    if(in_aufd_prm_req_updated == 1)
    {
        ...
        if (rtype == PARAMETER_REQUEST_TYPE_WRITE){
            if (bup_dcu_lrd_prm_write(prmId, mj_handle.in.aufd.prm_req.msg->val) == MJ_PRM_OK){
                is_prm_writed = true;
            }
        }
        mj_handle.out.prm_ans.msg->id = prmId;
        if (bup_dcu_lrd_prm_read(prmId, mj_handle.out.prm_ans.msg->val) == MJ_PRM_OK){
    ...
    if(in_mon_prm_req_updated == 1)
    {
        ...
        bool is_prm_writed = false;
        if (rtype == PARAMETER_REQUEST_TYPE_WRITE){
            if (bup_dcu_lrd_prm_write(prmId, mj_handle.in.mon.prm_req.msg->val) == MJ_PRM_OK){
                is_prm_writed = true;
            }
        }
        mj_handle.out.prm_ans.msg->id = prmId;
...
mj_status_t mj_bup_dcu_lrd_prm_init(mj_bup_dcu_lrd_t ** ptr){
        /* PRM */
    _bup_dcu_lrd_prm.dev_id = 22518;
    /* prms[p] */
    ...
    memcpy(&(_bup_dcu_lrd_prm.com_if_srv_mcast_req), default_com_if_srv_mcast_req, sizeof(default_com_if_srv_mcast_req) > 32 ? 32 : sizeof(default_com_if_srv_mcast_req));
    /* prms[p] */
    ...
    memcpy(&(_bup_dcu_lrd_prm.com_if_srv_mcast_ans), default_com_if_srv_mcast_ans, sizeof(default_com_if_srv_mcast_ans) > 32 ? 32 : sizeof(default_com_if_srv_mcast_ans));
    /* prms[p] */
    ...
    memcpy(&(_bup_dcu_lrd_prm.com_if_bro_bup_ctrl_mcast), default_com_if_bro_bup_ctrl_mcast, sizeof(default_com_if_bro_bup_ctrl_mcast) > 32 ? 32 : sizeof(default_com_if_bro_bup_ctrl_mcast));
    /* prms[p] */
    ...
    memcpy(&(_bup_dcu_lrd_prm.com_if_bro_bup_data_mcast), default_com_if_bro_bup_data_mcast, sizeof(default_com_if_bro_bup_data_mcast) > 32 ? 32 : sizeof(default_com_if_bro_bup_data_mcast));
    /* prms[p] */
    ...
    memcpy(&(_bup_dcu_lrd_prm.com_if_bup_internal_mcast), default_com_if_bup_internal_mcast, sizeof(default_com_if_bup_internal_mcast) > 32 ? 32 : sizeof(default_com_if_bup_internal_mcast));
    /* prms[p] */
    ...
    memcpy(&(_bup_dcu_lrd_prm.com_if_bro_bup_srv_mcast), default_com_if_bro_bup_srv_mcast, sizeof(default_com_if_bro_bup_srv_mcast) > 32 ? 32 : sizeof(default_com_if_bro_bup_srv_mcast));
    /* prms[p] */
    ...
    _bup_dcu_lrd_prm.vdc_scale = 0.017724609;
    _bup_dcu_lrd_prm.ocp_lvl = 115;
    _bup_dcu_lrd_prm.cur_lim = 95;
    _bup_dcu_lrd_prm.drv_ang_reverse = 0;
    _bup_dcu_lrd_prm.drv_current_reverse = 0;
    _bup_dcu_lrd_prm.drv_voltage_reverse = 0;
    _bup_dcu_lrd_prm.drv_zero = 0;
    _bup_dcu_lrd_prm.vdc_min = 10;
    _bup_dcu_lrd_prm.im_mode = 0;
    _bup_dcu_lrd_prm.ptp_kp = 0.0;
    _bup_dcu_lrd_prm.ptp_ki = 0.0;
    _bup_dcu_lrd_prm.ptp_kd = 0.0;
    _bup_dcu_lrd_prm.ohp_lvl = 0.0;
    _bup_dcu_lrd_prm.ohp_hyst = 5.0;
    _bup_dcu_lrd_prm.el_zero = 0.0;
    _bup_dcu_lrd_prm.pole_pairs = 0;
    _bup_dcu_lrd_prm.ph_resistance = 0.0;
    _bup_dcu_lrd_prm.ph_inductance = 0.0;
    _bup_dcu_lrd_prm.brake_unlock_voltage = 0.0;
    _bup_dcu_lrd_prm.brake_unlock_time = 0;
    _bup_dcu_lrd_prm.brake_hold_voltage = 0.0;
    _bup_dcu_lrd_prm.brake_lock_time = 0;
    _bup_dcu_lrd_prm.curr_kp = 0.0;
    _bup_dcu_lrd_prm.curr_ki = 0.0;
    _bup_dcu_lrd_prm.curr_kb = 0.0;
    _bup_dcu_lrd_prm.curr_kt = 0.0;
    _bup_dcu_lrd_prm.curr_kf = 0.0;
    _bup_dcu_lrd_prm.curr_fc = 0.0;
    _bup_dcu_lrd_prm.curr_err_lim = 0.0;
    _bup_dcu_lrd_prm.curr_out_lim = 0.0;
    _bup_dcu_lrd_prm.curr_out_rate_lim = 0.0;
    ...
    _bup_dcu_lrd_prm.load_speed_out_lim = 0.0;
    _bup_dcu_lrd_prm.load_speed_int_lim = 0.0;
    _bup_dcu_lrd_prm.load_speed_out_rate_lim = 0.0;
    _bup_dcu_lrd_prm.load_speed_err_rate_lim = 0.0;
    _bup_dcu_lrd_prm.load_speed_flt_fc = 0;
    _bup_dcu_lrd_prm.rotor_speed_flt_fc = 0;
    _bup_dcu_lrd_prm.load_ang_kp = 0.0;
    _bup_dcu_lrd_prm.load_ang_ki = 0.0;
    _bup_dcu_lrd_prm.load_ang_kb = 0.0;
    _bup_dcu_lrd_prm.load_ang_kt = 0.0;
    _bup_dcu_lrd_prm.load_ang_kf = 0.0;
    _bup_dcu_lrd_prm.load_ang_rev = 0;
    _bup_dcu_lrd_prm.load_ang_kd = 0.0;
    _bup_dcu_lrd_prm.load_ang_err_lim = 0.0;
    _bup_dcu_lrd_prm.load_ang_out_lim = 0.0;
    _bup_dcu_lrd_prm.load_ang_out_rate_lim = 0.0;
    _bup_dcu_lrd_prm.load_ang_err_rate_lim = 0.0;
    _bup_dcu_lrd_prm.load_ang_dz = 0.0;
    _bup_dcu_lrd_prm.load_ang_dz_en = 0;
    ...
    _bup_dcu_lrd_prm.rotor_speed_out_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_int_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_out_rate_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_err_rate_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_common_kp = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_common_ki = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_common_kb = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_common_kt = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_common_kf = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_common_err_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_common_out_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_common_int_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_common_out_rate_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_common_err_rate_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_diff_kp = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_diff_ki = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_diff_kb = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_diff_kt = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_diff_kf = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_diff_err_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_diff_out_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_diff_int_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_diff_out_rate_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_master_diff_err_rate_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_speed_role = 0;
    ...
    _bup_dcu_lrd_prm.rotor_ang_out_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_ang_out_rate_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_ang_err_rate_lim = 0.0;
    _bup_dcu_lrd_prm.rotor_ang_dz = 0.0;
    _bup_dcu_lrd_prm.rotor_ang_dz_en = 0;
    /* prms[p] */
    const uint8_t default_factory_date[] = { 0x8d,0x85,0x92,0x20,0x88,0x8d,0x94,0x8e,0x90,0x8c,0x80,0x96,0x88,0x88,0x21, 0x00};
    memcpy(&(_bup_dcu_lrd_prm.factory_date), default_factory_date, sizeof(default_factory_date) > 32 ? 32 : sizeof(default_factory_date));
    /* prms[p] */
    const uint8_t default_factory_number[] = { 0x8d,0x85,0x92,0x20,0x88,0x8d,0x94,0x8e,0x90,0x8c,0x80,0x96,0x88,0x88,0x21, 0x00};
    memcpy(&(_bup_dcu_lrd_prm.factory_number), default_factory_number, sizeof(default_factory_number) > 32 ? 32 : sizeof(default_factory_number));
    /* prms[p] */
    const uint8_t default_description[] = { 0x8d,0x85,0x92,0x20,0x88,0x8d,0x94,0x8e,0x90,0x8c,0x80,0x96,0x88,0x88,0x21, 0x00};
    memcpy(&(_bup_dcu_lrd_prm.description), default_description, sizeof(default_description) > 32 ? 32 : sizeof(default_description));
    mj_handle.prm.ptr = &_bup_dcu_lrd_prm;
    mj_handle.prm.read = bup_dcu_lrd_prm_read;
    mj_handle.prm.write = bup_dcu_lrd_prm_write;
    mj_handle.prm.list = bup_dcu_lrd_prm_list;
    *ptr = &mj_handle;
    return MJ_OK;
}

mj_status_t mj_bup_dcu_lrd_init(mj_drv_interface_t *drv, mj_bup_dcu_lrd_t ** ptr)
{
    //memset(&mj_handle,0,sizeof(mj_handle));
    if (mj_handle.prm.ptr == NULL){
        mj_bup_dcu_lrd_prm_init(ptr);
    }
    self_dev_id = mj_handle.prm.ptr->dev_id;
    p_drv = drv;
    ethInt = p_drv->udp4.create_interface(devMac, BUP_DCU_LRD_IP);

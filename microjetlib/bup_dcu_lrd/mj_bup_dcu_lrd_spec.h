#ifndef BUP_DCU_LRD_DEV_SPEC_H
#define BUP_DCU_LRD_DEV_SPEC_H
...
typedef struct bup_dcu_lrd_prm{
     /** dev_id [-] */
     int dev_id;
...
typedef struct mj_bup_dcu_lrd
{
     /** bup_dcu_lrd input messages */
     struct
     {
     ...
     /** bup_dcu_lrd parameters */
     struct
     {
          bup_dcu_lrd_prm_t *ptr;

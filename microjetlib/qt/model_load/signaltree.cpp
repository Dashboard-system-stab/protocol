...
static TreeNode *model_drivers_drivers_torques_ptr = 0;
...
static TreeNode *izu_ideal_values_ptr = 0;
static TreeNode *load_vels_ptr = 0;
static TreeNode *oeb_coords_ptr = 0;
static TreeNode *prm_ans_ptr = 0;
static TreeNode *zu_im_data_ptr = 0;
...
TreeNode * create_model_load_in_tree(mj_model_load_t * mj_ptr)
{
static mj_model_load_t *mj = mj_ptr;
...
model_drivers_drivers_torques_ptr = node->lch()->add("drivers_torques",[](){return QVariant(mj->in.model_drivers.drivers_torques.msg->hdr.cnt);});
model_drivers_drivers_torques_ptr->state = []()->int32_t{return mj->in.model_drivers.drivers_torques.state;};
model_drivers_drivers_torques_ptr->msgId = ID_DRIVERS_TORQUES;
model_drivers_drivers_torques_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.model_drivers.drivers_torques.msg->hdr.ts_s)+static_cast<double>(mj->in.model_drivers.drivers_torques.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("torque_gn",[](){return QVariant(mj->in.model_drivers.drivers_torques.msg->torque_gn);});
node->lch()->lch()->add("torque_vn",[](){return QVariant(mj->in.model_drivers.drivers_torques.msg->torque_vn);});
mj->in.model_drivers.drivers_torques.upd_cb = [](){ model_drivers_drivers_torques_ptr->upd(mj->in.model_drivers.drivers_torques.ts_s, mj->in.model_drivers.drivers_torques.ts_ns);};
...
TreeNode * create_model_load_out_tree(mj_model_load_t * mj_ptr)
{
static mj_model_load_t * mj = mj_ptr;
...
izu_ideal_values_ptr = node->add("izu_ideal_values",[](){return QVariant(mj->out.izu_ideal_values.msg->hdr.cnt);});
izu_ideal_values_ptr->tx_enable = &mj->out.izu_ideal_values.tx_enable;

node->lch()->add("gn",[](){return QVariant();});
node->lch()->lch()->add("vels",[](){return QVariant();});
node->lch()->lch()->lch()->add("ang_vel_x",[](){return QVariant(mj->out.izu_ideal_values.msg->gn.vels.ang_vel_x);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->gn.vels.ang_vel_x=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->lch()->add("ang_vel_y",[](){return QVariant(mj->out.izu_ideal_values.msg->gn.vels.ang_vel_y);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->gn.vels.ang_vel_y=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->lch()->add("ang_vel_z",[](){return QVariant(mj->out.izu_ideal_values.msg->gn.vels.ang_vel_z);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->gn.vels.ang_vel_z=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("angle",[](){return QVariant(mj->out.izu_ideal_values.msg->gn.angle);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->gn.angle=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("vn",[](){return QVariant();});
node->lch()->lch()->add("vels",[](){return QVariant();});
node->lch()->lch()->lch()->add("ang_vel_x",[](){return QVariant(mj->out.izu_ideal_values.msg->vn.vels.ang_vel_x);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->vn.vels.ang_vel_x=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->lch()->add("ang_vel_y",[](){return QVariant(mj->out.izu_ideal_values.msg->vn.vels.ang_vel_y);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->vn.vels.ang_vel_y=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->lch()->add("ang_vel_z",[](){return QVariant(mj->out.izu_ideal_values.msg->vn.vels.ang_vel_z);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->vn.vels.ang_vel_z=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("angle",[](){return QVariant(mj->out.izu_ideal_values.msg->vn.angle);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->vn.angle=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("gyro_angle_gn",[](){return QVariant();});
node->lch()->lch()->add("x",[](){return QVariant(mj->out.izu_ideal_values.msg->gyro_angle_gn.x);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->gyro_angle_gn.x=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("y",[](){return QVariant(mj->out.izu_ideal_values.msg->gyro_angle_gn.y);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->gyro_angle_gn.y=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("z",[](){return QVariant(mj->out.izu_ideal_values.msg->gyro_angle_gn.z);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->gyro_angle_gn.z=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("gyro_angle_vn",[](){return QVariant();});
node->lch()->lch()->add("x",[](){return QVariant(mj->out.izu_ideal_values.msg->gyro_angle_vn.x);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->gyro_angle_vn.x=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("y",[](){return QVariant(mj->out.izu_ideal_values.msg->gyro_angle_vn.y);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->gyro_angle_vn.y=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("z",[](){return QVariant(mj->out.izu_ideal_values.msg->gyro_angle_vn.z);})->setData =  [](QVariant data){ mj->out.izu_ideal_values.msg->gyro_angle_vn.z=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;

load_vels_ptr = node->add("load_vels",[](){return QVariant(mj->out.load_vels.msg->hdr.cnt);});
load_vels_ptr->tx_enable = &mj->out.load_vels.tx_enable;

node->lch()->add("vel_gn",[](){return QVariant(mj->out.load_vels.msg->vel_gn);})->setData =  [](QVariant data){ mj->out.load_vels.msg->vel_gn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("vel_vn",[](){return QVariant(mj->out.load_vels.msg->vel_vn);})->setData =  [](QVariant data){ mj->out.load_vels.msg->vel_vn=data.value<float>();return;};
node->lch()->lch()->editable = true;

oeb_coords_ptr = node->add("oeb_coords",[](){return QVariant(mj->out.oeb_coords.msg->hdr.cnt);});
oeb_coords_ptr->tx_enable = &mj->out.oeb_coords.tx_enable;

node->lch()->add("x",[](){return QVariant(mj->out.oeb_coords.msg->x);})->setData =  [](QVariant data){ mj->out.oeb_coords.msg->x=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("y",[](){return QVariant(mj->out.oeb_coords.msg->y);})->setData =  [](QVariant data){ mj->out.oeb_coords.msg->y=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("z",[](){return QVariant(mj->out.oeb_coords.msg->z);})->setData =  [](QVariant data){ mj->out.oeb_coords.msg->z=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("divergence_flag",[](){return QVariant(mj->out.oeb_coords.msg->divergence_flag);})->setData =  [](QVariant data){ mj->out.oeb_coords.msg->divergence_flag=data.value<bool>();return;};
node->lch()->lch()->editable = true;
...
zu_im_data_ptr = node->add("zu_im_data",[](){return QVariant(mj->out.zu_im_data.msg->hdr.cnt);});
zu_im_data_ptr->tx_enable = &mj->out.zu_im_data.tx_enable;

node->lch()->add("current_vn",[](){return QVariant(mj->out.zu_im_data.msg->current_vn);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->current_vn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("current_gn",[](){return QVariant(mj->out.zu_im_data.msg->current_gn);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->current_gn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("angle_vn",[](){return QVariant(mj->out.zu_im_data.msg->angle_vn);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->angle_vn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("angle_gn",[](){return QVariant(mj->out.zu_im_data.msg->angle_gn);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->angle_gn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("vdc",[](){return QVariant(mj->out.zu_im_data.msg->vdc);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->vdc=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("angle_oeb",[](){return QVariant(mj->out.zu_im_data.msg->angle_oeb);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->angle_oeb=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("gyro_data_gn",[](){return QVariant();});
node->lch()->lch()->add("velocity",[](){return QVariant();});
node->lch()->lch()->lch()->add("x",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_gn.velocity.x);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_gn.velocity.x=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->lch()->add("y",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_gn.velocity.y);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_gn.velocity.y=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->lch()->add("z",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_gn.velocity.z);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_gn.velocity.z=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("acceleration",[](){return QVariant();});
node->lch()->lch()->lch()->add("x",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_gn.acceleration.x);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_gn.acceleration.x=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->lch()->add("y",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_gn.acceleration.y);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_gn.acceleration.y=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->lch()->add("z",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_gn.acceleration.z);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_gn.acceleration.z=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("temperature",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_gn.temperature);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_gn.temperature=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("gyro_data_vn",[](){return QVariant();});
node->lch()->lch()->add("velocity",[](){return QVariant();});
node->lch()->lch()->lch()->add("x",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_vn.velocity.x);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_vn.velocity.x=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->lch()->add("y",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_vn.velocity.y);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_vn.velocity.y=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->lch()->add("z",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_vn.velocity.z);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_vn.velocity.z=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("acceleration",[](){return QVariant();});
node->lch()->lch()->lch()->add("x",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_vn.acceleration.x);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_vn.acceleration.x=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->lch()->add("y",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_vn.acceleration.y);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_vn.acceleration.y=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->lch()->add("z",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_vn.acceleration.z);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_vn.acceleration.z=data.value<float>();return;};
node->lch()->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("temperature",[](){return QVariant(mj->out.zu_im_data.msg->gyro_data_vn.temperature);})->setData =  [](QVariant data){ mj->out.zu_im_data.msg->gyro_data_vn.temperature=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;

return node;
};

TreeNode * create_model_load_params_tree(mj_model_load_t * mj_ptr){
static mj_model_load_t * mj = mj_ptr;

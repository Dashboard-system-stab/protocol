...
TreeNode * create_bup_dcu_lfd_in_tree(mj_bup_dcu_lfd_t * mj_ptr)
{
static mj_bup_dcu_lfd_t *mj = mj_ptr;
...
TreeNode * create_bup_dcu_lfd_out_tree(mj_bup_dcu_lfd_t * mj_ptr)
{
static mj_bup_dcu_lfd_t * mj = mj_ptr;
...
TreeNode * create_bup_dcu_lfd_params_tree(mj_bup_dcu_lfd_t * mj_ptr){
static mj_bup_dcu_lfd_t * mj = mj_ptr;

...
static TreeNode *imu_6dof_ga_state_ptr = 0;
...
TreeNode * create_imu_sensor_in_tree(mj_imu_sensor_t * mj_ptr)
{
static mj_imu_sensor_t *mj = mj_ptr;
...
TreeNode * create_imu_sensor_out_tree(mj_imu_sensor_t * mj_ptr)
{
static mj_imu_sensor_t * mj = mj_ptr;
...
imu_6dof_ga_state_ptr = node->add("imu_6dof_ga_state",[](){return QVariant(mj->out.imu_6dof_ga_state.msg->hdr.cnt);});
imu_6dof_ga_state_ptr->tx_enable = &mj->out.imu_6dof_ga_state.tx_enable;

node->lch()->add("omega",[](){return QVariant();});
node->lch()->lch()->add("x",[](){return QVariant(mj->out.imu_6dof_ga_state.msg->omega.x);})->setData =  [](QVariant data){ mj->out.imu_6dof_ga_state.msg->omega.x=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("y",[](){return QVariant(mj->out.imu_6dof_ga_state.msg->omega.y);})->setData =  [](QVariant data){ mj->out.imu_6dof_ga_state.msg->omega.y=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("z",[](){return QVariant(mj->out.imu_6dof_ga_state.msg->omega.z);})->setData =  [](QVariant data){ mj->out.imu_6dof_ga_state.msg->omega.z=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("a",[](){return QVariant();});
node->lch()->lch()->add("x",[](){return QVariant(mj->out.imu_6dof_ga_state.msg->a.x);})->setData =  [](QVariant data){ mj->out.imu_6dof_ga_state.msg->a.x=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("y",[](){return QVariant(mj->out.imu_6dof_ga_state.msg->a.y);})->setData =  [](QVariant data){ mj->out.imu_6dof_ga_state.msg->a.y=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("z",[](){return QVariant(mj->out.imu_6dof_ga_state.msg->a.z);})->setData =  [](QVariant data){ mj->out.imu_6dof_ga_state.msg->a.z=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("temp",[](){return QVariant(mj->out.imu_6dof_ga_state.msg->temp);})->setData =  [](QVariant data){ mj->out.imu_6dof_ga_state.msg->temp=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("is_valid",[](){return QVariant(mj->out.imu_6dof_ga_state.msg->is_valid);})->setData =  [](QVariant data){ mj->out.imu_6dof_ga_state.msg->is_valid=data.value<bool>();return;};
node->lch()->lch()->editable = true;
...
TreeNode * create_imu_sensor_params_tree(mj_imu_sensor_t * mj_ptr){
static mj_imu_sensor_t * mj = mj_ptr;

...
static TreeNode *cvs_bup_trig_ctrl_ptr = 0;
static TreeNode *cvs_prm_req_ptr = 0;
static TreeNode *model_trig_trig_model_state_ptr = 0;
static TreeNode *mon_bup_srv_trig_ctrl_ptr = 0;
static TreeNode *mon_cmd_req_ptr = 0;
static TreeNode *mon_msg_req_ptr = 0;
static TreeNode *mon_prm_req_ptr = 0;

static TreeNode *bup_trig_state_ptr = 0;
static TreeNode *cmd_ans_ptr = 0;
static TreeNode *formular_ptr = 0;
static TreeNode *msg_ans_ptr = 0;
static TreeNode *prm_ans_ptr = 0;
static TreeNode *tcu_state_ptr = 0;
static TreeNode *tcu_tel_ptr = 0;
static TreeNode *trig_model_input_ptr = 0;
...
TreeNode * create_bup_tcu_in_tree(mj_bup_tcu_t * mj_ptr)
{
static mj_bup_tcu_t *mj = mj_ptr;
...
cvs_node->isDev = true;
cvs_bup_trig_ctrl_ptr = node->lch()->add("bup_trig_ctrl",[](){return QVariant(mj->in.cvs.bup_trig_ctrl.msg->hdr.cnt);});
cvs_bup_trig_ctrl_ptr->state = []()->int32_t{return mj->in.cvs.bup_trig_ctrl.state;};
cvs_bup_trig_ctrl_ptr->msgId = ID_BUP_TRIG_CTRL;
cvs_bup_trig_ctrl_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.cvs.bup_trig_ctrl.msg->hdr.ts_s)+static_cast<double>(mj->in.cvs.bup_trig_ctrl.msg->hdr.ts_ns)/1e9);});

cvs_bup_trig_ctrl_ptr->isReq = true;
cvs_bup_trig_ctrl_ptr->srcId = KAUZU_CVS;
node->lch()->lch()->add("mode",[](){return QVariant((int32_t)(mj->in.cvs.bup_trig_ctrl.msg->mode));},[](){return (trig_status_str(mj->in.cvs.bup_trig_ctrl.msg->mode));});
node->lch()->lch()->add("voltage",[](){return QVariant(mj->in.cvs.bup_trig_ctrl.msg->voltage);});
mj->in.cvs.bup_trig_ctrl.upd_cb = [](){ cvs_bup_trig_ctrl_ptr->upd(mj->in.cvs.bup_trig_ctrl.ts_s, mj->in.cvs.bup_trig_ctrl.ts_ns);};
...
TreeNode * model_trig_node = node->add("model_trig",[](){return QVariant();});
model_trig_node->isDev = true;
model_trig_trig_model_state_ptr = node->lch()->add("trig_model_state",[](){return QVariant(mj->in.model_trig.trig_model_state.msg->hdr.cnt);});
model_trig_trig_model_state_ptr->state = []()->int32_t{return mj->in.model_trig.trig_model_state.state;};
model_trig_trig_model_state_ptr->msgId = ID_TRIG_MODEL_STATE;
model_trig_trig_model_state_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.model_trig.trig_model_state.msg->hdr.ts_s)+static_cast<double>(mj->in.model_trig.trig_model_state.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("ideal_ia",[](){return QVariant(mj->in.model_trig.trig_model_state.msg->ideal_ia);});
node->lch()->lch()->add("ideal_ib",[](){return QVariant(mj->in.model_trig.trig_model_state.msg->ideal_ib);});
node->lch()->lch()->add("ideal_ic",[](){return QVariant(mj->in.model_trig.trig_model_state.msg->ideal_ic);});
node->lch()->lch()->add("left_x",[](){return QVariant(mj->in.model_trig.trig_model_state.msg->left_x);});
node->lch()->lch()->add("right_x",[](){return QVariant(mj->in.model_trig.trig_model_state.msg->right_x);});
node->lch()->lch()->add("vdc",[](){return QVariant(mj->in.model_trig.trig_model_state.msg->vdc);});
node->lch()->lch()->add("sens_ia",[](){return QVariant(mj->in.model_trig.trig_model_state.msg->sens_ia);});
node->lch()->lch()->add("sens_ib",[](){return QVariant(mj->in.model_trig.trig_model_state.msg->sens_ib);});
node->lch()->lch()->add("sens_ic",[](){return QVariant(mj->in.model_trig.trig_model_state.msg->sens_ic);});
mj->in.model_trig.trig_model_state.upd_cb = [](){ model_trig_trig_model_state_ptr->upd(mj->in.model_trig.trig_model_state.ts_s, mj->in.model_trig.trig_model_state.ts_ns);};
TreeNode * mon_node = node->add("mon",[](){return QVariant();});
mon_node->isDev = true;
mon_bup_srv_trig_ctrl_ptr = node->lch()->add("bup_srv_trig_ctrl",[](){return QVariant(mj->in.mon.bup_srv_trig_ctrl.msg->hdr.cnt);});
mon_bup_srv_trig_ctrl_ptr->state = []()->int32_t{return mj->in.mon.bup_srv_trig_ctrl.state;};
mon_bup_srv_trig_ctrl_ptr->msgId = ID_BUP_SRV_TRIG_CTRL;
mon_bup_srv_trig_ctrl_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.mon.bup_srv_trig_ctrl.msg->hdr.ts_s)+static_cast<double>(mj->in.mon.bup_srv_trig_ctrl.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("mode",[](){return QVariant((int32_t)(mj->in.mon.bup_srv_trig_ctrl.msg->mode));},[](){return (trig_status_str(mj->in.mon.bup_srv_trig_ctrl.msg->mode));});
node->lch()->lch()->add("voltage",[](){return QVariant(mj->in.mon.bup_srv_trig_ctrl.msg->voltage);});
mj->in.mon.bup_srv_trig_ctrl.upd_cb = [](){ mon_bup_srv_trig_ctrl_ptr->upd(mj->in.mon.bup_srv_trig_ctrl.ts_s, mj->in.mon.bup_srv_trig_ctrl.ts_ns);};
...
TreeNode * create_bup_tcu_out_tree(mj_bup_tcu_t * mj_ptr)
{
static mj_bup_tcu_t * mj = mj_ptr;
TreeNode * node = new TreeNode("OUTPUT",[](){return QVariant();});
node->devIDs = devIDs;
node->devList = devList;
bup_trig_state_ptr = node->add("bup_trig_state",[](){return QVariant(mj->out.bup_trig_state.msg->hdr.cnt);});
bup_trig_state_ptr->tx = [](uint16_t dst){mj->out.bup_trig_state.tx(dst);};

node->lch()->add("status",[](){return QVariant((int32_t)(mj->out.bup_trig_state.msg->status));},[](){return (trig_status_str(mj->out.bup_trig_state.msg->status));})->setData =  [](QVariant data){ mj->out.bup_trig_state.msg->status=(trig_status)(data.value<int32_t>());return;};
...
node->lch()->add("err",[](){return QVariant((int32_t)(mj->out.bup_trig_state.msg->err));},[](){return (trig_error_str(mj->out.bup_trig_state.msg->err));})->setData =  [](QVariant data){ mj->out.bup_trig_state.msg->err=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
...
node->lch()->lch()->values.append("ACT");
node->lch()->lch()->intval.append(0);
node->lch()->lch()->intval.append(1);
node->lch()->lch()->intval.append(2);
...
node->lch()->add("act",[](){return QVariant(mj->out.bup_trig_state.msg->act);})->setData =  [](QVariant data){ mj->out.bup_trig_state.msg->act=data.value<bool>();return;};
node->lch()->lch()->editable = true;
...
tcu_state_ptr = node->add("tcu_state",[](){return QVariant(mj->out.tcu_state.msg->hdr.cnt);});
tcu_state_ptr->tx_enable = &mj->out.tcu_state.tx_enable;

node->lch()->add("mode",[](){return QVariant((int32_t)(mj->out.tcu_state.msg->mode));},[](){return (trig_status_str(mj->out.tcu_state.msg->mode));})->setData =  [](QVariant data){ mj->out.tcu_state.msg->mode=(trig_status)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("DISARM");
node->lch()->lch()->values.append("ARM");
...
node->lch()->lch()->add("a",[](){return QVariant(mj->out.tcu_state.msg->current.a);})->setData =  [](QVariant data){ mj->out.tcu_state.msg->current.a=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("b",[](){return QVariant(mj->out.tcu_state.msg->current.b);})->setData =  [](QVariant data){ mj->out.tcu_state.msg->current.b=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("c",[](){return QVariant(mj->out.tcu_state.msg->current.c);})->setData =  [](QVariant data){ mj->out.tcu_state.msg->current.c=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("power_vdc",[](){return QVariant(mj->out.tcu_state.msg->power_vdc);})->setData =  [](QVariant data){ mj->out.tcu_state.msg->power_vdc=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("err",[](){return QVariant((int32_t)(mj->out.tcu_state.msg->err));},[](){return (trig_error_str(mj->out.tcu_state.msg->err));})->setData =  [](QVariant data){ mj->out.tcu_state.msg->err=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("NONE");
node->lch()->lch()->values.append("BLOCK");
...
node->lch()->lch()->intval.append(10);
node->lch()->lch()->intval.append(11);
node->lch()->add("act",[](){return QVariant(mj->out.tcu_state.msg->act);})->setData =  [](QVariant data){ mj->out.tcu_state.msg->act=data.value<bool>();return;};
node->lch()->lch()->editable = true;

tcu_tel_ptr = node->add("tcu_tel",[](){return QVariant(mj->out.tcu_tel.msg->hdr.cnt);});
tcu_tel_ptr->tx_enable = &mj->out.tcu_tel.tx_enable;

node->lch()->add("mode",[](){return QVariant((int32_t)(mj->out.tcu_tel.msg->mode));},[](){return (trig_status_str(mj->out.tcu_tel.msg->mode));})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->mode=(trig_status)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("DISARM");
node->lch()->lch()->values.append("ARM");
...
node->lch()->lch()->intval.append(1701252286);
node->lch()->lch()->intval.append(1701252272);
node->lch()->add("vdc",[](){return QVariant(mj->out.tcu_tel.msg->vdc);})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->vdc=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("left",[](){return QVariant();});
node->lch()->lch()->add("V",[](){return QVariant(mj->out.tcu_tel.msg->left.V);})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->left.V=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("I",[](){return QVariant(mj->out.tcu_tel.msg->left.I);})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->left.I=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("right",[](){return QVariant();});
node->lch()->lch()->add("V",[](){return QVariant(mj->out.tcu_tel.msg->right.V);})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->right.V=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("I",[](){return QVariant(mj->out.tcu_tel.msg->right.I);})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->right.I=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("current",[](){return QVariant();});
node->lch()->lch()->add("a",[](){return QVariant(mj->out.tcu_tel.msg->current.a);})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->current.a=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("b",[](){return QVariant(mj->out.tcu_tel.msg->current.b);})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->current.b=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("c",[](){return QVariant(mj->out.tcu_tel.msg->current.c);})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->current.c=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("power_vdc",[](){return QVariant(mj->out.tcu_tel.msg->power_vdc);})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->power_vdc=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("pwm",[](){return QVariant();});
node->lch()->lch()->add("a",[](){return QVariant(mj->out.tcu_tel.msg->pwm.a);})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->pwm.a=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("b",[](){return QVariant(mj->out.tcu_tel.msg->pwm.b);})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->pwm.b=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("c",[](){return QVariant(mj->out.tcu_tel.msg->pwm.c);})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->pwm.c=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("err",[](){return QVariant((int32_t)(mj->out.tcu_tel.msg->err));},[](){return (trig_error_str(mj->out.tcu_tel.msg->err));})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->err=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("NONE");
node->lch()->lch()->values.append("BLOCK");
...
node->lch()->lch()->intval.append(10);
node->lch()->lch()->intval.append(11);
node->lch()->add("on",[](){return QVariant((int32_t)(mj->out.tcu_tel.msg->on));},[](){return (relay_signal_state_str(mj->out.tcu_tel.msg->on));})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->on=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("manual",[](){return QVariant((int32_t)(mj->out.tcu_tel.msg->manual));},[](){return (relay_signal_state_str(mj->out.tcu_tel.msg->manual));})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->manual=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("block",[](){return QVariant((int32_t)(mj->out.tcu_tel.msg->block));},[](){return (relay_signal_state_str(mj->out.tcu_tel.msg->block));})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->block=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("sync",[](){return QVariant((int32_t)(mj->out.tcu_tel.msg->sync));},[](){return (relay_signal_state_str(mj->out.tcu_tel.msg->sync));})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->sync=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("inv_octw",[](){return QVariant((int32_t)(mj->out.tcu_tel.msg->inv_octw));},[](){return (relay_signal_state_str(mj->out.tcu_tel.msg->inv_octw));})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->inv_octw=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("inv_fault",[](){return QVariant((int32_t)(mj->out.tcu_tel.msg->inv_fault));},[](){return (relay_signal_state_str(mj->out.tcu_tel.msg->inv_fault));})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->inv_fault=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("en_gate",[](){return QVariant((int32_t)(mj->out.tcu_tel.msg->en_gate));},[](){return (relay_signal_state_str(mj->out.tcu_tel.msg->en_gate));})->setData =  [](QVariant data){ mj->out.tcu_tel.msg->en_gate=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
trig_model_input_ptr = node->add("trig_model_input",[](){return QVariant(mj->out.trig_model_input.msg->hdr.cnt);});
trig_model_input_ptr->tx_enable = &mj->out.trig_model_input.tx_enable;

node->lch()->add("va",[](){return QVariant(mj->out.trig_model_input.msg->va);})->setData =  [](QVariant data){ mj->out.trig_model_input.msg->va=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("vb",[](){return QVariant(mj->out.trig_model_input.msg->vb);})->setData =  [](QVariant data){ mj->out.trig_model_input.msg->vb=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("vc",[](){return QVariant(mj->out.trig_model_input.msg->vc);})->setData =  [](QVariant data){ mj->out.trig_model_input.msg->vc=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("enbable",[](){return QVariant(mj->out.trig_model_input.msg->enbable);})->setData =  [](QVariant data){ mj->out.trig_model_input.msg->enbable=data.value<bool>();return;};
node->lch()->lch()->editable = true;

return node;
};

TreeNode * create_bup_tcu_params_tree(mj_bup_tcu_t * mj_ptr){
static mj_bup_tcu_t * mj = mj_ptr;
...
node->lch()->add("val",[](){return QVariant(prm2QVariant(mj->out.prm_req.msg->id,(uint8_t*)mj->out.prm_req.msg->val,sizeof(mj->out.prm_req.msg->val)));})->setData =  [](QVariant data){ QVariant2prm(mj->out.prm_req.msg->id,(uint8_t*)mj->out.prm_req.msg->val,sizeof(mj->out.prm_req.msg->val),data);return;};
node->lch()->lch()->editable = true;
auto model_trig_ptr = node->add("model_trig",[](){return QVariant(mj->out.prm_req.msg->hdr.cnt);});
model_trig_ptr->tx = [](uint16_t dst){mj->out.prm_req.tx(dst);};
node->lch()->add("type",[](){return QVariant((int32_t)(mj->out.prm_req.msg->type));})->setData =  [](QVariant data){ mj->out.prm_req.msg->type=(parameter_request_type)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("READ");
node->lch()->lch()->intval.append(0);

...
node->lch()->lch()->add("ang_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->ang_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->ang_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->ang_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->ang_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->ang_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->ang_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->ang_pid_state.out);});
node->lch()->lch()->add("rotor_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->rotor_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->rotor_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->rotor_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->rotor_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->rotor_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->rotor_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->rotor_spd_pid_state.out);});
node->lch()->lch()->add("load_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->load_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->load_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->load_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->load_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->load_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->load_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->load_spd_pid_state.out);});
node->lch()->lch()->add("curr_q_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_q_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_q_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_q_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_q_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_q_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_q_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_q_pid_state.out);});
node->lch()->lch()->add("curr_d_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_d_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_d_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_d_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_d_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_d_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_d_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lfd.dcu_tel.msg->curr_d_pid_state.out);});
...
node->lch()->lch()->add("ang_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->ang_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->ang_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->ang_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->ang_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->ang_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->ang_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->ang_pid_state.out);});
node->lch()->lch()->add("rotor_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->rotor_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->rotor_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->rotor_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->rotor_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->rotor_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->rotor_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->rotor_spd_pid_state.out);});
node->lch()->lch()->add("load_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->load_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->load_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->load_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->load_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->load_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->load_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->load_spd_pid_state.out);});
node->lch()->lch()->add("curr_q_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_q_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_q_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_q_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_q_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_q_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_q_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_q_pid_state.out);});
node->lch()->lch()->add("curr_d_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_d_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_d_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_d_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_d_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_d_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_d_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lrd.dcu_tel.msg->curr_d_pid_state.out);});
...
node->lch()->lch()->add("ang_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->ang_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->ang_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->ang_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->ang_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->ang_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->ang_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->ang_pid_state.out);});
node->lch()->lch()->add("rotor_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->rotor_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->rotor_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->rotor_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->rotor_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->rotor_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->rotor_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->rotor_spd_pid_state.out);});
node->lch()->lch()->add("load_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->load_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->load_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->load_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->load_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->load_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->load_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->load_spd_pid_state.out);});
node->lch()->lch()->add("curr_q_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_q_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_q_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_q_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_q_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_q_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_q_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_q_pid_state.out);});
node->lch()->lch()->add("curr_d_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_d_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_d_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_d_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_d_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_d_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_d_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_lst.dcu_tel.msg->curr_d_pid_state.out);});
...
node->lch()->lch()->add("ang_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->ang_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->ang_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->ang_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->ang_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->ang_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->ang_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->ang_pid_state.out);});
node->lch()->lch()->add("rotor_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->rotor_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->rotor_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->rotor_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->rotor_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->rotor_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->rotor_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->rotor_spd_pid_state.out);});
node->lch()->lch()->add("load_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->load_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->load_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->load_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->load_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->load_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->load_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->load_spd_pid_state.out);});
node->lch()->lch()->add("curr_q_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_q_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_q_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_q_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_q_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_q_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_q_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_q_pid_state.out);});
node->lch()->lch()->add("curr_d_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_d_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_d_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_d_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_d_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_d_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_d_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rfd.dcu_tel.msg->curr_d_pid_state.out);});
...
node->lch()->lch()->add("ang_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->ang_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->ang_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->ang_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->ang_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->ang_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->ang_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->ang_pid_state.out);});
node->lch()->lch()->add("rotor_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->rotor_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->rotor_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->rotor_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->rotor_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->rotor_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->rotor_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->rotor_spd_pid_state.out);});
node->lch()->lch()->add("load_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->load_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->load_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->load_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->load_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->load_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->load_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->load_spd_pid_state.out);});
node->lch()->lch()->add("curr_q_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_q_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_q_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_q_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_q_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_q_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_q_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_q_pid_state.out);});
node->lch()->lch()->add("curr_d_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_d_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_d_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_d_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_d_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_d_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_d_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rrd.dcu_tel.msg->curr_d_pid_state.out);});
...
node->lch()->lch()->add("ang_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->ang_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->ang_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->ang_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->ang_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->ang_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->ang_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->ang_pid_state.out);});
node->lch()->lch()->add("rotor_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->rotor_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->rotor_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->rotor_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->rotor_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->rotor_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->rotor_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->rotor_spd_pid_state.out);});
node->lch()->lch()->add("load_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->load_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->load_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->load_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->load_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->load_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->load_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->load_spd_pid_state.out);});
node->lch()->lch()->add("curr_q_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_q_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_q_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_q_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_q_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_q_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_q_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_q_pid_state.out);});
node->lch()->lch()->add("curr_d_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_d_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_d_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_d_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_d_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_d_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_d_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.bup_dcu_rst.dcu_tel.msg->curr_d_pid_state.out);});
...
node->lch()->lch()->add("ang_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.dcu.dcu_tel.msg->ang_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.dcu.dcu_tel.msg->ang_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.dcu.dcu_tel.msg->ang_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.dcu.dcu_tel.msg->ang_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.dcu.dcu_tel.msg->ang_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.dcu.dcu_tel.msg->ang_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.dcu.dcu_tel.msg->ang_pid_state.out);});
node->lch()->lch()->add("rotor_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.dcu.dcu_tel.msg->rotor_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.dcu.dcu_tel.msg->rotor_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.dcu.dcu_tel.msg->rotor_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.dcu.dcu_tel.msg->rotor_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.dcu.dcu_tel.msg->rotor_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.dcu.dcu_tel.msg->rotor_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.dcu.dcu_tel.msg->rotor_spd_pid_state.out);});
node->lch()->lch()->add("load_spd_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.dcu.dcu_tel.msg->load_spd_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.dcu.dcu_tel.msg->load_spd_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.dcu.dcu_tel.msg->load_spd_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.dcu.dcu_tel.msg->load_spd_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.dcu.dcu_tel.msg->load_spd_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.dcu.dcu_tel.msg->load_spd_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.dcu.dcu_tel.msg->load_spd_pid_state.out);});
node->lch()->lch()->add("curr_q_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_q_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_q_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_q_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_q_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_q_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_q_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_q_pid_state.out);});
node->lch()->lch()->add("curr_d_pid_state",[](){return QVariant();});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_d_pid_state.err);});
node->lch()->lch()->lch()->add("cor_err",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_d_pid_state.cor_err);});
node->lch()->lch()->lch()->add("feed_forward",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_d_pid_state.feed_forward);});
node->lch()->lch()->lch()->add("track",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_d_pid_state.track);});
node->lch()->lch()->lch()->add("back",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_d_pid_state.back);});
node->lch()->lch()->lch()->add("int_val",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_d_pid_state.int_val);});
node->lch()->lch()->lch()->add("out",[](){return QVariant(mj->in.dcu.dcu_tel.msg->curr_d_pid_state.out);});

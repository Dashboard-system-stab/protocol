...
TreeNode * create_pion_mku_vn_in_tree(mj_pion_mku_vn_t * mj_ptr)
{
static mj_pion_mku_vn_t *mj = mj_ptr;
...
pion_mku_gn_pion_power_ctrl_ptr = node->lch()->add("pion_power_ctrl",[](){return QVariant(mj->in.pion_mku_gn.pion_power_ctrl.msg->hdr.cnt);});
pion_mku_gn_pion_power_ctrl_ptr->state = []()->int32_t{return mj->in.pion_mku_gn.pion_power_ctrl.state;};
pion_mku_gn_pion_power_ctrl_ptr->msgId = ID_PION_POWER_CTRL;
pion_mku_gn_pion_power_ctrl_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.pion_mku_gn.pion_power_ctrl.msg->hdr.ts_s)+static_cast<double>(mj->in.pion_mku_gn.pion_power_ctrl.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("cam_narrow_tv",[](){return QVariant((int32_t)(mj->in.pion_mku_gn.pion_power_ctrl.msg->cam_narrow_tv));},[](){return (power_line_state_str(mj->in.pion_mku_gn.pion_power_ctrl.msg->cam_narrow_tv));});
node->lch()->lch()->add("cam_wide_tv",[](){return QVariant((int32_t)(mj->in.pion_mku_gn.pion_power_ctrl.msg->cam_wide_tv));},[](){return (power_line_state_str(mj->in.pion_mku_gn.pion_power_ctrl.msg->cam_wide_tv));});
node->lch()->lch()->add("cam_tp",[](){return QVariant((int32_t)(mj->in.pion_mku_gn.pion_power_ctrl.msg->cam_tp));},[](){return (power_line_state_str(mj->in.pion_mku_gn.pion_power_ctrl.msg->cam_tp));});
node->lch()->lch()->add("ld",[](){return QVariant((int32_t)(mj->in.pion_mku_gn.pion_power_ctrl.msg->ld));},[](){return (power_line_state_str(mj->in.pion_mku_gn.pion_power_ctrl.msg->ld));});
node->lch()->lch()->add("cvs",[](){return QVariant((int32_t)(mj->in.pion_mku_gn.pion_power_ctrl.msg->cvs));},[](){return (power_line_state_str(mj->in.pion_mku_gn.pion_power_ctrl.msg->cvs));});
node->lch()->lch()->add("gyro",[](){return QVariant((int32_t)(mj->in.pion_mku_gn.pion_power_ctrl.msg->gyro));},[](){return (power_line_state_str(mj->in.pion_mku_gn.pion_power_ctrl.msg->gyro));});
node->lch()->lch()->add("line_5v",[](){return QVariant((int32_t)(mj->in.pion_mku_gn.pion_power_ctrl.msg->line_5v));},[](){return (power_line_state_str(mj->in.pion_mku_gn.pion_power_ctrl.msg->line_5v));});
node->lch()->lch()->add("adcu_vn",[](){return QVariant((int32_t)(mj->in.pion_mku_gn.pion_power_ctrl.msg->adcu_vn));},[](){return (power_line_state_str(mj->in.pion_mku_gn.pion_power_ctrl.msg->adcu_vn));});
mj->in.pion_mku_gn.pion_power_ctrl.upd_cb = [](){ pion_mku_gn_pion_power_ctrl_ptr->upd(mj->in.pion_mku_gn.pion_power_ctrl.ts_s, mj->in.pion_mku_gn.pion_power_ctrl.ts_ns);};
return node;
};


TreeNode * create_pion_mku_vn_out_tree(mj_pion_mku_vn_t * mj_ptr)
{
static mj_pion_mku_vn_t * mj = mj_ptr;
TreeNode * node = new TreeNode("OUTPUT",[](){return QVariant();});
node->devIDs = devIDs;
node->devList = devList;
aim_ang_vn_sens_state_ptr = node->add("aim_ang_vn_sens_state",[](){return QVariant(mj->out.aim_ang_vn_sens_state.msg->hdr.cnt);});
aim_ang_vn_sens_state_ptr->tx_enable = &mj->out.aim_ang_vn_sens_state.tx_enable;

node->lch()->add("angle",[](){return QVariant(mj->out.aim_ang_vn_sens_state.msg->angle);})->setData =  [](QVariant data){ mj->out.aim_ang_vn_sens_state.msg->angle=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("status",[](){return QVariant((int32_t)(mj->out.aim_ang_vn_sens_state.msg->status));},[](){return (ang_sens_status_str(mj->out.aim_ang_vn_sens_state.msg->status));})->setData =  [](QVariant data){ mj->out.aim_ang_vn_sens_state.msg->status=(ang_sens_status)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
...
ld_heater_state_ptr = node->add("ld_heater_state",[](){return QVariant(mj->out.ld_heater_state.msg->hdr.cnt);});
ld_heater_state_ptr->tx_enable = &mj->out.ld_heater_state.tx_enable;

node->lch()->add("mode",[](){return QVariant((int32_t)(mj->out.ld_heater_state.msg->mode));},[](){return (heater_mode_str(mj->out.ld_heater_state.msg->mode));})->setData =  [](QVariant data){ mj->out.ld_heater_state.msg->mode=(heater_mode)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
...
node->lch()->lch()->intval.append(1);
node->lch()->lch()->intval.append(2);
node->lch()->add("state",[](){return QVariant((int32_t)(mj->out.ld_heater_state.msg->state));},[](){return (heater_status_str(mj->out.ld_heater_state.msg->state));})->setData =  [](QVariant data){ mj->out.ld_heater_state.msg->state=(heater_status)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("OFF");
node->lch()->lch()->values.append("ON");
node->lch()->lch()->values.append("FAULT");
...
node->lch()->lch()->intval.append(1);
node->lch()->lch()->intval.append(2);
node->lch()->add("temp",[](){return QVariant(mj->out.ld_heater_state.msg->temp);})->setData =  [](QVariant data){ mj->out.ld_heater_state.msg->temp=data.value<float>();return;};
node->lch()->lch()->editable = true;
...
pion_drv_vn_state_ptr = node->add("pion_drv_vn_state",[](){return QVariant(mj->out.pion_drv_vn_state.msg->hdr.cnt);});
pion_drv_vn_state_ptr->tx = [](uint16_t dst){mj->out.pion_drv_vn_state.tx(dst);};

node->lch()->add("mode",[](){return QVariant((int32_t)(mj->out.pion_drv_vn_state.msg->mode));},[](){return (drv_ctrl_mode_str(mj->out.pion_drv_vn_state.msg->mode));})->setData =  [](QVariant data){ mj->out.pion_drv_vn_state.msg->mode=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("OFF");
node->lch()->lch()->values.append("FREEMOVE");
...
node->lch()->lch()->intval.append(14);
node->lch()->lch()->intval.append(15);
node->lch()->add("error",[](){return QVariant((int32_t)(mj->out.pion_drv_vn_state.msg->error));},[](){return (drv_ctrl_error_str(mj->out.pion_drv_vn_state.msg->error));})->setData =  [](QVariant data){ mj->out.pion_drv_vn_state.msg->error=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("NONE");
node->lch()->lch()->values.append("BLOCK");
...
node->lch()->lch()->intval.append(14);
node->lch()->lch()->intval.append(15);
node->lch()->add("status",[](){return QVariant((int32_t)(mj->out.pion_drv_vn_state.msg->status));},[](){return (dcu_status_str(mj->out.pion_drv_vn_state.msg->status));})->setData =  [](QVariant data){ mj->out.pion_drv_vn_state.msg->status=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("OFF");
node->lch()->lch()->values.append("PREPARE");
...
node->lch()->lch()->intval.append(5);
node->lch()->lch()->intval.append(-1);
node->lch()->add("limit",[](){return QVariant((int32_t)(mj->out.pion_drv_vn_state.msg->limit));},[](){return (move_limit_state_str(mj->out.pion_drv_vn_state.msg->limit));})->setData =  [](QVariant data){ mj->out.pion_drv_vn_state.msg->limit=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOW");
node->lch()->lch()->values.append("NONE");
node->lch()->lch()->values.append("LIMIT_UP");
...
node->lch()->lch()->intval.append(2);
node->lch()->lch()->intval.append(3);
node->lch()->add("angle",[](){return QVariant(mj->out.pion_drv_vn_state.msg->angle);})->setData =  [](QVariant data){ mj->out.pion_drv_vn_state.msg->angle=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("speed",[](){return QVariant(mj->out.pion_drv_vn_state.msg->speed);})->setData =  [](QVariant data){ mj->out.pion_drv_vn_state.msg->speed=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("g_angle",[](){return QVariant(mj->out.pion_drv_vn_state.msg->g_angle);})->setData =  [](QVariant data){ mj->out.pion_drv_vn_state.msg->g_angle=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("g_speed",[](){return QVariant(mj->out.pion_drv_vn_state.msg->g_speed);})->setData =  [](QVariant data){ mj->out.pion_drv_vn_state.msg->g_speed=data.value<float>();return;};
node->lch()->lch()->editable = true;
...
TreeNode * create_pion_mku_vn_params_tree(mj_pion_mku_vn_t * mj_ptr){
static mj_pion_mku_vn_t * mj = mj_ptr;

...
TreeNode * create_bup_dcu_lrd_in_tree(mj_bup_dcu_lrd_t * mj_ptr)
{
static mj_bup_dcu_lrd_t *mj = mj_ptr;
...
TreeNode * create_bup_dcu_lrd_out_tree(mj_bup_dcu_lrd_t * mj_ptr)
{
static mj_bup_dcu_lrd_t * mj = mj_ptr;
...
TreeNode * create_bup_dcu_lrd_params_tree(mj_bup_dcu_lrd_t * mj_ptr){
static mj_bup_dcu_lrd_t * mj = mj_ptr;

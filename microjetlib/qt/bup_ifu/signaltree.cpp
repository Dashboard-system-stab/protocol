...
static TreeNode *bup_dcu_gn_dcu_gn_state_ptr = 0;
static TreeNode *bup_dcu_vn_dcu_vn_state_ptr = 0;
static TreeNode *bup_pcm_pcm_state_ptr = 0;
static TreeNode *bup_tcu_tcu_state_ptr = 0;
static TreeNode *cvs_bup_sig_ctrl_ptr = 0;
static TreeNode *cvs_prm_req_ptr = 0;
static TreeNode *mon_bup_srv_sig_ctrl_ptr = 0;
static TreeNode *mon_cmd_req_ptr = 0;
static TreeNode *mon_prm_req_ptr = 0;
static TreeNode *wp_imu_wp_imu_state_ptr = 0;

static TreeNode *bup_sig_state_ptr = 0;
static TreeNode *cmd_ans_ptr = 0;
static TreeNode *dbg_ptr = 0;
static TreeNode *formular_ptr = 0;
static TreeNode *ifu_state_ptr = 0;
...
TreeNode * create_bup_ifu_in_tree(mj_bup_ifu_t * mj_ptr)
{
static mj_bup_ifu_t *mj = mj_ptr;
...
bup_dcu_gn_dcu_gn_state_ptr = node->lch()->add("dcu_gn_state",[](){return QVariant(mj->in.bup_dcu_gn.dcu_gn_state.msg->hdr.cnt);});
bup_dcu_gn_dcu_gn_state_ptr->state = []()->int32_t{return mj->in.bup_dcu_gn.dcu_gn_state.state;};
bup_dcu_gn_dcu_gn_state_ptr->msgId = ID_DCU_GN_STATE;
bup_dcu_gn_dcu_gn_state_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.bup_dcu_gn.dcu_gn_state.msg->hdr.ts_s)+static_cast<double>(mj->in.bup_dcu_gn.dcu_gn_state.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("mode",[](){return QVariant((int32_t)(mj->in.bup_dcu_gn.dcu_gn_state.msg->mode));},[](){return (drv_ctrl_mode_str(mj->in.bup_dcu_gn.dcu_gn_state.msg->mode));});
node->lch()->lch()->add("error",[](){return QVariant((int32_t)(mj->in.bup_dcu_gn.dcu_gn_state.msg->error));},[](){return (drv_ctrl_error_str(mj->in.bup_dcu_gn.dcu_gn_state.msg->error));});
node->lch()->lch()->add("status",[](){return QVariant((int32_t)(mj->in.bup_dcu_gn.dcu_gn_state.msg->status));},[](){return (dcu_status_str(mj->in.bup_dcu_gn.dcu_gn_state.msg->status));});
node->lch()->lch()->add("load_sens_state",[](){return QVariant((int32_t)(mj->in.bup_dcu_gn.dcu_gn_state.msg->load_sens_state));},[](){return (ang_sens_status_str(mj->in.bup_dcu_gn.dcu_gn_state.msg->load_sens_state));});
node->lch()->lch()->add("load_sens_angle",[](){return QVariant(mj->in.bup_dcu_gn.dcu_gn_state.msg->load_sens_angle);});
node->lch()->lch()->add("current",[](){return QVariant();});
node->lch()->lch()->lch()->add("a",[](){return QVariant(mj->in.bup_dcu_gn.dcu_gn_state.msg->current.a);});
node->lch()->lch()->lch()->add("b",[](){return QVariant(mj->in.bup_dcu_gn.dcu_gn_state.msg->current.b);});
node->lch()->lch()->lch()->add("c",[](){return QVariant(mj->in.bup_dcu_gn.dcu_gn_state.msg->current.c);});
node->lch()->lch()->add("rotor_sens_angle",[](){return QVariant(mj->in.bup_dcu_gn.dcu_gn_state.msg->rotor_sens_angle);});
node->lch()->lch()->add("power_vdc",[](){return QVariant(mj->in.bup_dcu_gn.dcu_gn_state.msg->power_vdc);});
node->lch()->lch()->add("rotor_sens_state",[](){return QVariant((int32_t)(mj->in.bup_dcu_gn.dcu_gn_state.msg->rotor_sens_state));},[](){return (ang_sens_status_str(mj->in.bup_dcu_gn.dcu_gn_state.msg->rotor_sens_state));});
mj->in.bup_dcu_gn.dcu_gn_state.upd_cb = [](){ bup_dcu_gn_dcu_gn_state_ptr->upd(mj->in.bup_dcu_gn.dcu_gn_state.ts_s, mj->in.bup_dcu_gn.dcu_gn_state.ts_ns);};
TreeNode * bup_dcu_vn_node = node->add("bup_dcu_vn",[](){return QVariant();});
bup_dcu_vn_node->isDev = true;
bup_dcu_vn_dcu_vn_state_ptr = node->lch()->add("dcu_vn_state",[](){return QVariant(mj->in.bup_dcu_vn.dcu_vn_state.msg->hdr.cnt);});
bup_dcu_vn_dcu_vn_state_ptr->state = []()->int32_t{return mj->in.bup_dcu_vn.dcu_vn_state.state;};
bup_dcu_vn_dcu_vn_state_ptr->msgId = ID_DCU_VN_STATE;
bup_dcu_vn_dcu_vn_state_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.bup_dcu_vn.dcu_vn_state.msg->hdr.ts_s)+static_cast<double>(mj->in.bup_dcu_vn.dcu_vn_state.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("mode",[](){return QVariant((int32_t)(mj->in.bup_dcu_vn.dcu_vn_state.msg->mode));},[](){return (drv_ctrl_mode_str(mj->in.bup_dcu_vn.dcu_vn_state.msg->mode));});
node->lch()->lch()->add("error",[](){return QVariant((int32_t)(mj->in.bup_dcu_vn.dcu_vn_state.msg->error));},[](){return (drv_ctrl_error_str(mj->in.bup_dcu_vn.dcu_vn_state.msg->error));});
node->lch()->lch()->add("status",[](){return QVariant((int32_t)(mj->in.bup_dcu_vn.dcu_vn_state.msg->status));},[](){return (dcu_status_str(mj->in.bup_dcu_vn.dcu_vn_state.msg->status));});
node->lch()->lch()->add("load_sens_state",[](){return QVariant((int32_t)(mj->in.bup_dcu_vn.dcu_vn_state.msg->load_sens_state));},[](){return (ang_sens_status_str(mj->in.bup_dcu_vn.dcu_vn_state.msg->load_sens_state));});
node->lch()->lch()->add("load_sens_angle",[](){return QVariant(mj->in.bup_dcu_vn.dcu_vn_state.msg->load_sens_angle);});
node->lch()->lch()->add("current",[](){return QVariant();});
node->lch()->lch()->lch()->add("a",[](){return QVariant(mj->in.bup_dcu_vn.dcu_vn_state.msg->current.a);});
node->lch()->lch()->lch()->add("b",[](){return QVariant(mj->in.bup_dcu_vn.dcu_vn_state.msg->current.b);});
node->lch()->lch()->lch()->add("c",[](){return QVariant(mj->in.bup_dcu_vn.dcu_vn_state.msg->current.c);});
node->lch()->lch()->add("rotor_sens_angle",[](){return QVariant(mj->in.bup_dcu_vn.dcu_vn_state.msg->rotor_sens_angle);});
node->lch()->lch()->add("power_vdc",[](){return QVariant(mj->in.bup_dcu_vn.dcu_vn_state.msg->power_vdc);});
node->lch()->lch()->add("rotor_sens_state",[](){return QVariant((int32_t)(mj->in.bup_dcu_vn.dcu_vn_state.msg->rotor_sens_state));},[](){return (ang_sens_status_str(mj->in.bup_dcu_vn.dcu_vn_state.msg->rotor_sens_state));});
mj->in.bup_dcu_vn.dcu_vn_state.upd_cb = [](){ bup_dcu_vn_dcu_vn_state_ptr->upd(mj->in.bup_dcu_vn.dcu_vn_state.ts_s, mj->in.bup_dcu_vn.dcu_vn_state.ts_ns);};
TreeNode * bup_pcm_node = node->add("bup_pcm",[](){return QVariant();});
bup_pcm_node->isDev = true;
bup_pcm_pcm_state_ptr = node->lch()->add("pcm_state",[](){return QVariant(mj->in.bup_pcm.pcm_state.msg->hdr.cnt);});
bup_pcm_pcm_state_ptr->state = []()->int32_t{return mj->in.bup_pcm.pcm_state.state;};
bup_pcm_pcm_state_ptr->msgId = ID_PCM_STATE;
bup_pcm_pcm_state_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.bup_pcm.pcm_state.msg->hdr.ts_s)+static_cast<double>(mj->in.bup_pcm.pcm_state.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("battery_voltage",[](){return QVariant(mj->in.bup_pcm.pcm_state.msg->battery_voltage);});
node->lch()->lch()->add("inv_dcu_vn",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->inv_dcu_vn));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->inv_dcu_vn));});
node->lch()->lch()->add("inv_dcu_gn",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->inv_dcu_gn));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->inv_dcu_gn));});
node->lch()->lch()->add("inv_trig",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->inv_trig));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->inv_trig));});
node->lch()->lch()->add("load_ang_sens_vn",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->load_ang_sens_vn));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->load_ang_sens_vn));});
node->lch()->lch()->add("load_ang_sens_gn",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->load_ang_sens_gn));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->load_ang_sens_gn));});
node->lch()->lch()->add("rotor_ang_sens_vn",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->rotor_ang_sens_vn));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->rotor_ang_sens_vn));});
node->lch()->lch()->add("rotor_ang_sens_gn",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->rotor_ang_sens_gn));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->rotor_ang_sens_gn));});
node->lch()->lch()->add("bg_power",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->bg_power));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->bg_power));});
node->lch()->lch()->add("cvs_power",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->cvs_power));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->cvs_power));});
node->lch()->lch()->add("cvs_enable",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->cvs_enable));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->cvs_enable));});
node->lch()->lch()->add("oeb_power",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->oeb_power));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->oeb_power));});
node->lch()->lch()->add("oeb_enable",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->oeb_enable));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->oeb_enable));});
node->lch()->lch()->add("skim",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->skim));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->skim));});
node->lch()->lch()->add("pmf_power",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->pmf_power));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->pmf_power));});
node->lch()->lch()->add("pmf_enable",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->pmf_enable));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->pmf_enable));});
node->lch()->lch()->add("pno",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->pno));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->pno));});
node->lch()->lch()->add("pui",[](){return QVariant((int32_t)(mj->in.bup_pcm.pcm_state.msg->pui));},[](){return (relay_signal_state_str(mj->in.bup_pcm.pcm_state.msg->pui));});
mj->in.bup_pcm.pcm_state.upd_cb = [](){ bup_pcm_pcm_state_ptr->upd(mj->in.bup_pcm.pcm_state.ts_s, mj->in.bup_pcm.pcm_state.ts_ns);};
...
cvs_node->isDev = true;
cvs_bup_sig_ctrl_ptr = node->lch()->add("bup_sig_ctrl",[](){return QVariant(mj->in.cvs.bup_sig_ctrl.msg->hdr.cnt);});
cvs_bup_sig_ctrl_ptr->state = []()->int32_t{return mj->in.cvs.bup_sig_ctrl.state;};
cvs_bup_sig_ctrl_ptr->msgId = ID_BUP_SIG_CTRL;
cvs_bup_sig_ctrl_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.cvs.bup_sig_ctrl.msg->hdr.ts_s)+static_cast<double>(mj->in.cvs.bup_sig_ctrl.msg->hdr.ts_ns)/1e9);});

cvs_bup_sig_ctrl_ptr->isReq = true;
cvs_bup_sig_ctrl_ptr->srcId = KAUZU_CVS;
node->lch()->lch()->add("ring_acu",[](){return QVariant((int32_t)(mj->in.cvs.bup_sig_ctrl.msg->ring_acu));},[](){return (relay_signal_state_str(mj->in.cvs.bup_sig_ctrl.msg->ring_acu));});
node->lch()->lch()->add("drv_vn",[](){return QVariant((int32_t)(mj->in.cvs.bup_sig_ctrl.msg->drv_vn));},[](){return (relay_signal_state_str(mj->in.cvs.bup_sig_ctrl.msg->drv_vn));});
node->lch()->lch()->add("drv_gn",[](){return QVariant((int32_t)(mj->in.cvs.bup_sig_ctrl.msg->drv_gn));},[](){return (relay_signal_state_str(mj->in.cvs.bup_sig_ctrl.msg->drv_gn));});
mj->in.cvs.bup_sig_ctrl.upd_cb = [](){ cvs_bup_sig_ctrl_ptr->upd(mj->in.cvs.bup_sig_ctrl.ts_s, mj->in.cvs.bup_sig_ctrl.ts_ns);};
...
mon_node->isDev = true;
mon_bup_srv_sig_ctrl_ptr = node->lch()->add("bup_srv_sig_ctrl",[](){return QVariant(mj->in.mon.bup_srv_sig_ctrl.msg->hdr.cnt);});
mon_bup_srv_sig_ctrl_ptr->state = []()->int32_t{return mj->in.mon.bup_srv_sig_ctrl.state;};
mon_bup_srv_sig_ctrl_ptr->msgId = ID_BUP_SRV_SIG_CTRL;
mon_bup_srv_sig_ctrl_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.mon.bup_srv_sig_ctrl.msg->hdr.ts_s)+static_cast<double>(mj->in.mon.bup_srv_sig_ctrl.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("ring_acu",[](){return QVariant((int32_t)(mj->in.mon.bup_srv_sig_ctrl.msg->ring_acu));},[](){return (relay_signal_state_str(mj->in.mon.bup_srv_sig_ctrl.msg->ring_acu));});
node->lch()->lch()->add("drv_vn",[](){return QVariant((int32_t)(mj->in.mon.bup_srv_sig_ctrl.msg->drv_vn));},[](){return (relay_signal_state_str(mj->in.mon.bup_srv_sig_ctrl.msg->drv_vn));});
node->lch()->lch()->add("drv_gn",[](){return QVariant((int32_t)(mj->in.mon.bup_srv_sig_ctrl.msg->drv_gn));},[](){return (relay_signal_state_str(mj->in.mon.bup_srv_sig_ctrl.msg->drv_gn));});
mj->in.mon.bup_srv_sig_ctrl.upd_cb = [](){ mon_bup_srv_sig_ctrl_ptr->upd(mj->in.mon.bup_srv_sig_ctrl.ts_s, mj->in.mon.bup_srv_sig_ctrl.ts_ns);};
...
TreeNode * create_bup_ifu_out_tree(mj_bup_ifu_t * mj_ptr)
{
static mj_bup_ifu_t * mj = mj_ptr;
TreeNode * node = new TreeNode("OUTPUT",[](){return QVariant();});
node->devIDs = devIDs;
node->devList = devList;
bup_sig_state_ptr = node->add("bup_sig_state",[](){return QVariant(mj->out.bup_sig_state.msg->hdr.cnt);});
bup_sig_state_ptr->tx = [](uint16_t dst){mj->out.bup_sig_state.tx(dst);};

node->lch()->add("cmb",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->cmb));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->cmb));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->cmb=(int8_t)(data.value<int32_t>());return;};
...
node->lch()->add("pat",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->pat));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->pat));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->pat=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("dbl",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->dbl));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->dbl));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->dbl=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("acu",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->acu));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->acu));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->acu=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("rvd",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->rvd));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->rvd));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->rvd=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("up",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->up));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->up));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->up=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("down",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->down));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->down));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->down=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("du",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->du));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->du));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->du=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("fire_blk",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->fire_blk));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->fire_blk));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->fire_blk=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("tvtp",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->tvtp));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->tvtp));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->tvtp=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("ring_acu",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->ring_acu));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->ring_acu));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->ring_acu=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("gsh",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->gsh));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->gsh));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->gsh=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("pz",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->pz));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->pz));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->pz=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("lead",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->lead));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->lead));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->lead=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("channel",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->channel));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->channel));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->channel=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("capture",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->capture));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->capture));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->capture=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("fire",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->fire));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->fire));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->fire=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("nav_gn",[](){return QVariant(mj->out.bup_sig_state.msg->nav_gn);})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->nav_gn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("nav_vn",[](){return QVariant(mj->out.bup_sig_state.msg->nav_vn);})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->nav_vn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("balance_gn",[](){return QVariant(mj->out.bup_sig_state.msg->balance_gn);})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->balance_gn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("balance_vn",[](){return QVariant(mj->out.bup_sig_state.msg->balance_vn);})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->balance_vn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("drv_vn",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->drv_vn));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->drv_vn));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->drv_vn=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("drv_gn",[](){return QVariant((int32_t)(mj->out.bup_sig_state.msg->drv_gn));},[](){return (relay_signal_state_str(mj->out.bup_sig_state.msg->drv_gn));})->setData =  [](QVariant data){ mj->out.bup_sig_state.msg->drv_gn=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
ifu_state_ptr = node->add("ifu_state",[](){return QVariant(mj->out.ifu_state.msg->hdr.cnt);});
ifu_state_ptr->tx_enable = &mj->out.ifu_state.tx_enable;

node->lch()->add("cmb",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->cmb));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->cmb));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->cmb=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("pat",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->pat));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->pat));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->pat=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("dbl",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->dbl));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->dbl));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->dbl=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("acu",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->acu));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->acu));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->acu=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("rvd",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->rvd));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->rvd));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->rvd=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("up",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->up));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->up));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->up=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("down",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->down));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->down));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->down=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("du",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->du));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->du));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->du=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("fire_blk",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->fire_blk));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->fire_blk));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->fire_blk=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("tvtp",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->tvtp));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->tvtp));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->tvtp=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("ring_acu",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->ring_acu));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->ring_acu));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->ring_acu=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("gsh",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->gsh));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->gsh));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->gsh=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("pz",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->pz));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->pz));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->pz=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("lead",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->lead));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->lead));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->lead=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("channel",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->channel));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->channel));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->channel=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("capture",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->capture));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->capture));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->capture=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("fire",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->fire));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->fire));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->fire=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("nav_gn",[](){return QVariant(mj->out.ifu_state.msg->nav_gn);})->setData =  [](QVariant data){ mj->out.ifu_state.msg->nav_gn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("nav_vn",[](){return QVariant(mj->out.ifu_state.msg->nav_vn);})->setData =  [](QVariant data){ mj->out.ifu_state.msg->nav_vn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("balance_gn",[](){return QVariant(mj->out.ifu_state.msg->balance_gn);})->setData =  [](QVariant data){ mj->out.ifu_state.msg->balance_gn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("balance_vn",[](){return QVariant(mj->out.ifu_state.msg->balance_vn);})->setData =  [](QVariant data){ mj->out.ifu_state.msg->balance_vn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("drv_vn",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->drv_vn));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->drv_vn));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->drv_vn=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("drv_gn",[](){return QVariant((int32_t)(mj->out.ifu_state.msg->drv_gn));},[](){return (relay_signal_state_str(mj->out.ifu_state.msg->drv_gn));})->setData =  [](QVariant data){ mj->out.ifu_state.msg->drv_gn=(relay_signal_state)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("HIGH");
node->lch()->lch()->values.append("LOW");
...
TreeNode * create_bup_ifu_params_tree(mj_bup_ifu_t * mj_ptr){
static mj_bup_ifu_t * mj = mj_ptr;

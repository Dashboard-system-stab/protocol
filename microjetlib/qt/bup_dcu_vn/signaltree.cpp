...
TreeNode * create_bup_dcu_vn_in_tree(mj_bup_dcu_vn_t * mj_ptr)
{
static mj_bup_dcu_vn_t *mj = mj_ptr;
...
TreeNode * create_bup_dcu_vn_out_tree(mj_bup_dcu_vn_t * mj_ptr)
{
static mj_bup_dcu_vn_t * mj = mj_ptr;
TreeNode * node = new TreeNode("OUTPUT",[](){return QVariant();});
node->devIDs = devIDs;
node->devList = devList;
bup_drv_vn_state_ptr = node->add("bup_drv_vn_state",[](){return QVariant(mj->out.bup_drv_vn_state.msg->hdr.cnt);});
bup_drv_vn_state_ptr->tx = [](uint16_t dst){mj->out.bup_drv_vn_state.tx(dst);};

node->lch()->add("mode",[](){return QVariant((int32_t)(mj->out.bup_drv_vn_state.msg->mode));},[](){return (drv_ctrl_mode_str(mj->out.bup_drv_vn_state.msg->mode));})->setData =  [](QVariant data){ mj->out.bup_drv_vn_state.msg->mode=(int8_t)(data.value<int32_t>());return;};
...
node->lch()->add("error",[](){return QVariant((int32_t)(mj->out.bup_drv_vn_state.msg->error));},[](){return (drv_ctrl_error_str(mj->out.bup_drv_vn_state.msg->error));})->setData =  [](QVariant data){ mj->out.bup_drv_vn_state.msg->error=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
...
node->lch()->lch()->intval.append(14);
node->lch()->lch()->intval.append(15);
node->lch()->add("status",[](){return QVariant((int32_t)(mj->out.bup_drv_vn_state.msg->status));},[](){return (dcu_status_str(mj->out.bup_drv_vn_state.msg->status));})->setData =  [](QVariant data){ mj->out.bup_drv_vn_state.msg->status=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("OFF");
...
node->lch()->lch()->intval.append(5);
node->lch()->lch()->intval.append(-1);
node->lch()->add("limit",[](){return QVariant((int32_t)(mj->out.bup_drv_vn_state.msg->limit));},[](){return (move_limit_state_str(mj->out.bup_drv_vn_state.msg->limit));})->setData =  [](QVariant data){ mj->out.bup_drv_vn_state.msg->limit=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
...
node->lch()->lch()->intval.append(2);
node->lch()->lch()->intval.append(3);
node->lch()->add("angle",[](){return QVariant(mj->out.bup_drv_vn_state.msg->angle);})->setData =  [](QVariant data){ mj->out.bup_drv_vn_state.msg->angle=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("sync_delay_us",[](){return QVariant(mj->out.bup_drv_vn_state.msg->sync_delay_us);})->setData =  [](QVariant data){ mj->out.bup_drv_vn_state.msg->sync_delay_us=data.value<int32_t>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("transit_process",[](){return QVariant((int32_t)(mj->out.bup_drv_vn_state.msg->transit_process));},[](){return (transit_proc_status_str(mj->out.bup_drv_vn_state.msg->transit_process));})->setData =  [](QVariant data){ mj->out.bup_drv_vn_state.msg->transit_process=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOW");
node->lch()->lch()->values.append("NONE");
...
dcu_vn_state_ptr = node->add("dcu_vn_state",[](){return QVariant(mj->out.dcu_vn_state.msg->hdr.cnt);});
dcu_vn_state_ptr->tx_enable = &mj->out.dcu_vn_state.tx_enable;

node->lch()->add("mode",[](){return QVariant((int32_t)(mj->out.dcu_vn_state.msg->mode));},[](){return (drv_ctrl_mode_str(mj->out.dcu_vn_state.msg->mode));})->setData =  [](QVariant data){ mj->out.dcu_vn_state.msg->mode=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("OFF");
node->lch()->lch()->values.append("FREEMOVE");
...
node->lch()->lch()->intval.append(14);
node->lch()->lch()->intval.append(15);
node->lch()->add("error",[](){return QVariant((int32_t)(mj->out.dcu_vn_state.msg->error));},[](){return (drv_ctrl_error_str(mj->out.dcu_vn_state.msg->error));})->setData =  [](QVariant data){ mj->out.dcu_vn_state.msg->error=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("NONE");
node->lch()->lch()->values.append("BLOCK");
...
node->lch()->lch()->intval.append(14);
node->lch()->lch()->intval.append(15);
node->lch()->add("status",[](){return QVariant((int32_t)(mj->out.dcu_vn_state.msg->status));},[](){return (dcu_status_str(mj->out.dcu_vn_state.msg->status));})->setData =  [](QVariant data){ mj->out.dcu_vn_state.msg->status=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("OFF");
node->lch()->lch()->values.append("PREPARE");
...
node->lch()->lch()->intval.append(5);
node->lch()->lch()->intval.append(-1);
node->lch()->add("load_sens_state",[](){return QVariant((int32_t)(mj->out.dcu_vn_state.msg->load_sens_state));},[](){return (ang_sens_status_str(mj->out.dcu_vn_state.msg->load_sens_state));})->setData =  [](QVariant data){ mj->out.dcu_vn_state.msg->load_sens_state=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOW");
node->lch()->lch()->values.append("PREPARE");
node->lch()->lch()->values.append("UNCONNECTED");
...
node->lch()->lch()->intval.append(4);
node->lch()->lch()->intval.append(-1);
node->lch()->add("load_sens_angle",[](){return QVariant(mj->out.dcu_vn_state.msg->load_sens_angle);})->setData =  [](QVariant data){ mj->out.dcu_vn_state.msg->load_sens_angle=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("current",[](){return QVariant();});
node->lch()->lch()->add("a",[](){return QVariant(mj->out.dcu_vn_state.msg->current.a);})->setData =  [](QVariant data){ mj->out.dcu_vn_state.msg->current.a=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("b",[](){return QVariant(mj->out.dcu_vn_state.msg->current.b);})->setData =  [](QVariant data){ mj->out.dcu_vn_state.msg->current.b=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("c",[](){return QVariant(mj->out.dcu_vn_state.msg->current.c);})->setData =  [](QVariant data){ mj->out.dcu_vn_state.msg->current.c=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("rotor_sens_angle",[](){return QVariant(mj->out.dcu_vn_state.msg->rotor_sens_angle);})->setData =  [](QVariant data){ mj->out.dcu_vn_state.msg->rotor_sens_angle=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("power_vdc",[](){return QVariant(mj->out.dcu_vn_state.msg->power_vdc);})->setData =  [](QVariant data){ mj->out.dcu_vn_state.msg->power_vdc=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("rotor_sens_state",[](){return QVariant((int32_t)(mj->out.dcu_vn_state.msg->rotor_sens_state));},[](){return (ang_sens_status_str(mj->out.dcu_vn_state.msg->rotor_sens_state));})->setData =  [](QVariant data){ mj->out.dcu_vn_state.msg->rotor_sens_state=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOW");
node->lch()->lch()->values.append("PREPARE");
node->lch()->lch()->values.append("UNCONNECTED");
...
izu_vn_drive_ctrl_ptr = node->add("izu_vn_drive_ctrl",[](){return QVariant(mj->out.izu_vn_drive_ctrl.msg->hdr.cnt);});
izu_vn_drive_ctrl_ptr->tx_enable = &mj->out.izu_vn_drive_ctrl.tx_enable;

node->lch()->add("voltage",[](){return QVariant();});
node->lch()->lch()->add("[0]",[](){return QVariant(mj->out.izu_vn_drive_ctrl.msg->voltage[0]);})->setData =  [](QVariant data){ mj->out.izu_vn_drive_ctrl.msg->voltage[0]=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("[1]",[](){return QVariant(mj->out.izu_vn_drive_ctrl.msg->voltage[1]);})->setData =  [](QVariant data){ mj->out.izu_vn_drive_ctrl.msg->voltage[1]=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("[2]",[](){return QVariant(mj->out.izu_vn_drive_ctrl.msg->voltage[2]);})->setData =  [](QVariant data){ mj->out.izu_vn_drive_ctrl.msg->voltage[2]=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("connected",[](){return QVariant(mj->out.izu_vn_drive_ctrl.msg->connected);})->setData =  [](QVariant data){ mj->out.izu_vn_drive_ctrl.msg->connected=data.value<bool>();return;};
node->lch()->lch()->editable = true;
...
wp_ang_vn_sens_state_ptr = node->add("wp_ang_vn_sens_state",[](){return QVariant(mj->out.wp_ang_vn_sens_state.msg->hdr.cnt);});
wp_ang_vn_sens_state_ptr->tx_enable = &mj->out.wp_ang_vn_sens_state.tx_enable;

node->lch()->add("angle",[](){return QVariant(mj->out.wp_ang_vn_sens_state.msg->angle);})->setData =  [](QVariant data){ mj->out.wp_ang_vn_sens_state.msg->angle=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("status",[](){return QVariant((int32_t)(mj->out.wp_ang_vn_sens_state.msg->status));},[](){return (ang_sens_status_str(mj->out.wp_ang_vn_sens_state.msg->status));})->setData =  [](QVariant data){ mj->out.wp_ang_vn_sens_state.msg->status=(ang_sens_status)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOW");
node->lch()->lch()->values.append("PREPARE");
node->lch()->lch()->values.append("UNCONNECTED");
...
TreeNode * create_bup_dcu_vn_params_tree(mj_bup_dcu_vn_t * mj_ptr){
static mj_bup_dcu_vn_t * mj = mj_ptr;

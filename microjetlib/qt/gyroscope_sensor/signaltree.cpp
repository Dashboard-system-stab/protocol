...
static TreeNode *gyro_1d_state_ptr = 0;
...
TreeNode * create_gyroscope_sensor_in_tree(mj_gyroscope_sensor_t * mj_ptr)
{
static mj_gyroscope_sensor_t *mj = mj_ptr;
...
TreeNode * create_gyroscope_sensor_out_tree(mj_gyroscope_sensor_t * mj_ptr)
{
static mj_gyroscope_sensor_t * mj = mj_ptr;
...
gyro_1d_state_ptr = node->add("gyro_1d_state",[](){return QVariant(mj->out.gyro_1d_state.msg->hdr.cnt);});
gyro_1d_state_ptr->tx_enable = &mj->out.gyro_1d_state.tx_enable;

node->lch()->add("omega",[](){return QVariant(mj->out.gyro_1d_state.msg->omega);})->setData =  [](QVariant data){ mj->out.gyro_1d_state.msg->omega=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("temp",[](){return QVariant(mj->out.gyro_1d_state.msg->temp);})->setData =  [](QVariant data){ mj->out.gyro_1d_state.msg->temp=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("is_valid",[](){return QVariant(mj->out.gyro_1d_state.msg->is_valid);})->setData =  [](QVariant data){ mj->out.gyro_1d_state.msg->is_valid=data.value<bool>();return;};
node->lch()->lch()->editable = true;
...
TreeNode * create_gyroscope_sensor_params_tree(mj_gyroscope_sensor_t * mj_ptr){
static mj_gyroscope_sensor_t * mj = mj_ptr;

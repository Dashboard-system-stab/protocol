...
TreeNode * create_wp_imu_in_tree(mj_wp_imu_t * mj_ptr)
{
static mj_wp_imu_t *mj = mj_ptr;
...
TreeNode * create_wp_imu_out_tree(mj_wp_imu_t * mj_ptr)
{
static mj_wp_imu_t * mj = mj_ptr;
...
TreeNode * create_wp_imu_params_tree(mj_wp_imu_t * mj_ptr){
static mj_wp_imu_t * mj = mj_ptr;

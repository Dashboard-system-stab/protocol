...
TreeNode * create_bup_dcu_rfd_in_tree(mj_bup_dcu_rfd_t * mj_ptr)
{
static mj_bup_dcu_rfd_t *mj = mj_ptr;
...
TreeNode * create_bup_dcu_rfd_out_tree(mj_bup_dcu_rfd_t * mj_ptr)
{
static mj_bup_dcu_rfd_t * mj = mj_ptr;
...
TreeNode * create_bup_dcu_rfd_params_tree(mj_bup_dcu_rfd_t * mj_ptr){
static mj_bup_dcu_rfd_t * mj = mj_ptr;

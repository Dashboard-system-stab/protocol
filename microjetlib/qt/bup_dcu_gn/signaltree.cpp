...
static TreeNode *bup_dcu_vn_wp_ang_vn_sens_state_ptr = 0;
static TreeNode *bup_ifu_ifu_state_ptr = 0;
static TreeNode *bup_tcu_tcu_state_ptr = 0;
static TreeNode *cvs_bup_drv_ctrl_ptr = 0;
static TreeNode *cvs_prm_req_ptr = 0;
static TreeNode *cvs_track_state_ptr = 0;
static TreeNode *model_drivers_drivers_sens_ptr = 0;
static TreeNode *model_load_zu_im_data_ptr = 0;
static TreeNode *mon_bup_srv_drv_ctrl_ptr = 0;
static TreeNode *mon_cmd_req_ptr = 0;
static TreeNode *mon_msg_req_ptr = 0;
static TreeNode *mon_prm_req_ptr = 0;
static TreeNode *pion_mku_gn_aim_ang_gn_sens_state_ptr = 0;
static TreeNode *wp_imu_wp_imu_state_ptr = 0;

static TreeNode *bup_drv_gn_state_ptr = 0;
static TreeNode *cmd_ans_ptr = 0;
static TreeNode *dbg_ptr = 0;
static TreeNode *dcu_gn_state_ptr = 0;
static TreeNode *dcu_tel_ptr = 0;
static TreeNode *formular_ptr = 0;
static TreeNode *izu_gn_drive_ctrl_ptr = 0;
static TreeNode *msg_ans_ptr = 0;
static TreeNode *prm_ans_ptr = 0;
static TreeNode *ptp_state_ptr = 0;
static TreeNode *wp_ang_gn_sens_state_ptr = 0;
...
TreeNode * create_bup_dcu_gn_in_tree(mj_bup_dcu_gn_t * mj_ptr)
{
static mj_bup_dcu_gn_t *mj = mj_ptr;
...
bup_dcu_vn_wp_ang_vn_sens_state_ptr = node->lch()->add("wp_ang_vn_sens_state",[](){return QVariant(mj->in.bup_dcu_vn.wp_ang_vn_sens_state.msg->hdr.cnt);});
bup_dcu_vn_wp_ang_vn_sens_state_ptr->state = []()->int32_t{return mj->in.bup_dcu_vn.wp_ang_vn_sens_state.state;};
bup_dcu_vn_wp_ang_vn_sens_state_ptr->msgId = ID_WP_ANG_VN_SENS_STATE;
bup_dcu_vn_wp_ang_vn_sens_state_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.bup_dcu_vn.wp_ang_vn_sens_state.msg->hdr.ts_s)+static_cast<double>(mj->in.bup_dcu_vn.wp_ang_vn_sens_state.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("angle",[](){return QVariant(mj->in.bup_dcu_vn.wp_ang_vn_sens_state.msg->angle);});
node->lch()->lch()->add("status",[](){return QVariant((int32_t)(mj->in.bup_dcu_vn.wp_ang_vn_sens_state.msg->status));},[](){return (ang_sens_status_str(mj->in.bup_dcu_vn.wp_ang_vn_sens_state.msg->status));});
mj->in.bup_dcu_vn.wp_ang_vn_sens_state.upd_cb = [](){ bup_dcu_vn_wp_ang_vn_sens_state_ptr->upd(mj->in.bup_dcu_vn.wp_ang_vn_sens_state.ts_s, mj->in.bup_dcu_vn.wp_ang_vn_sens_state.ts_ns);};
...
bup_tcu_tcu_state_ptr = node->lch()->add("tcu_state",[](){return QVariant(mj->in.bup_tcu.tcu_state.msg->hdr.cnt);});
bup_tcu_tcu_state_ptr->state = []()->int32_t{return mj->in.bup_tcu.tcu_state.state;};
bup_tcu_tcu_state_ptr->msgId = ID_TCU_STATE;
bup_tcu_tcu_state_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.bup_tcu.tcu_state.msg->hdr.ts_s)+static_cast<double>(mj->in.bup_tcu.tcu_state.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("mode",[](){return QVariant((int32_t)(mj->in.bup_tcu.tcu_state.msg->mode));},[](){return (trig_status_str(mj->in.bup_tcu.tcu_state.msg->mode));});
node->lch()->lch()->add("current",[](){return QVariant();});
node->lch()->lch()->lch()->add("a",[](){return QVariant(mj->in.bup_tcu.tcu_state.msg->current.a);});
node->lch()->lch()->lch()->add("b",[](){return QVariant(mj->in.bup_tcu.tcu_state.msg->current.b);});
node->lch()->lch()->lch()->add("c",[](){return QVariant(mj->in.bup_tcu.tcu_state.msg->current.c);});
node->lch()->lch()->add("power_vdc",[](){return QVariant(mj->in.bup_tcu.tcu_state.msg->power_vdc);});
node->lch()->lch()->add("err",[](){return QVariant((int32_t)(mj->in.bup_tcu.tcu_state.msg->err));},[](){return (trig_error_str(mj->in.bup_tcu.tcu_state.msg->err));});
node->lch()->lch()->add("act",[](){return QVariant(mj->in.bup_tcu.tcu_state.msg->act);});
mj->in.bup_tcu.tcu_state.upd_cb = [](){ bup_tcu_tcu_state_ptr->upd(mj->in.bup_tcu.tcu_state.ts_s, mj->in.bup_tcu.tcu_state.ts_ns);};
TreeNode * cvs_node = node->add("cvs",[](){return QVariant();});
cvs_node->isDev = true;
cvs_bup_drv_ctrl_ptr = node->lch()->add("bup_drv_ctrl",[](){return QVariant(mj->in.cvs.bup_drv_ctrl.msg->hdr.cnt);});
cvs_bup_drv_ctrl_ptr->state = []()->int32_t{return mj->in.cvs.bup_drv_ctrl.state;};
cvs_bup_drv_ctrl_ptr->msgId = ID_BUP_DRV_CTRL;
cvs_bup_drv_ctrl_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.cvs.bup_drv_ctrl.msg->hdr.ts_s)+static_cast<double>(mj->in.cvs.bup_drv_ctrl.msg->hdr.ts_ns)/1e9);});

cvs_bup_drv_ctrl_ptr->isReq = true;
cvs_bup_drv_ctrl_ptr->srcId = KAUZU_CVS;
node->lch()->lch()->add("az",[](){return QVariant();});
node->lch()->lch()->lch()->add("mode",[](){return QVariant((int32_t)(mj->in.cvs.bup_drv_ctrl.msg->az.mode));},[](){return (drv_ctrl_mode_str(mj->in.cvs.bup_drv_ctrl.msg->az.mode));});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.cvs.bup_drv_ctrl.msg->az.err);});
node->lch()->lch()->lch()->add("angle",[](){return QVariant(mj->in.cvs.bup_drv_ctrl.msg->az.angle);});
node->lch()->lch()->lch()->add("speed",[](){return QVariant(mj->in.cvs.bup_drv_ctrl.msg->az.speed);});
node->lch()->lch()->lch()->add("voltage",[](){return QVariant(mj->in.cvs.bup_drv_ctrl.msg->az.voltage);});
node->lch()->lch()->lch()->add("current",[](){return QVariant(mj->in.cvs.bup_drv_ctrl.msg->az.current);});
node->lch()->lch()->add("el",[](){return QVariant();});
node->lch()->lch()->lch()->add("mode",[](){return QVariant((int32_t)(mj->in.cvs.bup_drv_ctrl.msg->el.mode));},[](){return (drv_ctrl_mode_str(mj->in.cvs.bup_drv_ctrl.msg->el.mode));});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.cvs.bup_drv_ctrl.msg->el.err);});
node->lch()->lch()->lch()->add("angle",[](){return QVariant(mj->in.cvs.bup_drv_ctrl.msg->el.angle);});
node->lch()->lch()->lch()->add("speed",[](){return QVariant(mj->in.cvs.bup_drv_ctrl.msg->el.speed);});
node->lch()->lch()->lch()->add("voltage",[](){return QVariant(mj->in.cvs.bup_drv_ctrl.msg->el.voltage);});
node->lch()->lch()->lch()->add("current",[](){return QVariant(mj->in.cvs.bup_drv_ctrl.msg->el.current);});
mj->in.cvs.bup_drv_ctrl.upd_cb = [](){ cvs_bup_drv_ctrl_ptr->upd(mj->in.cvs.bup_drv_ctrl.ts_s, mj->in.cvs.bup_drv_ctrl.ts_ns);};
...
TreeNode * model_drivers_node = node->add("model_drivers",[](){return QVariant();});
model_drivers_node->isDev = true;
model_drivers_drivers_sens_ptr = node->lch()->add("drivers_sens",[](){return QVariant(mj->in.model_drivers.drivers_sens.msg->hdr.cnt);});
model_drivers_drivers_sens_ptr->state = []()->int32_t{return mj->in.model_drivers.drivers_sens.state;};
model_drivers_drivers_sens_ptr->msgId = ID_DRIVERS_SENS;
model_drivers_drivers_sens_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.model_drivers.drivers_sens.msg->hdr.ts_s)+static_cast<double>(mj->in.model_drivers.drivers_sens.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("currents_gn",[](){return QVariant();});
node->lch()->lch()->lch()->add("[0]",[](){return QVariant(mj->in.model_drivers.drivers_sens.msg->currents_gn[0]);});
node->lch()->lch()->lch()->add("[1]",[](){return QVariant(mj->in.model_drivers.drivers_sens.msg->currents_gn[1]);});
node->lch()->lch()->lch()->add("[2]",[](){return QVariant(mj->in.model_drivers.drivers_sens.msg->currents_gn[2]);});
node->lch()->lch()->add("currents_vn",[](){return QVariant();});
node->lch()->lch()->lch()->add("[0]",[](){return QVariant(mj->in.model_drivers.drivers_sens.msg->currents_vn[0]);});
node->lch()->lch()->lch()->add("[1]",[](){return QVariant(mj->in.model_drivers.drivers_sens.msg->currents_vn[1]);});
node->lch()->lch()->lch()->add("[2]",[](){return QVariant(mj->in.model_drivers.drivers_sens.msg->currents_vn[2]);});
node->lch()->lch()->add("rotor_angle_gn",[](){return QVariant(mj->in.model_drivers.drivers_sens.msg->rotor_angle_gn);});
node->lch()->lch()->add("rotor_angle_vn",[](){return QVariant(mj->in.model_drivers.drivers_sens.msg->rotor_angle_vn);});
node->lch()->lch()->add("v_nom",[](){return QVariant(mj->in.model_drivers.drivers_sens.msg->v_nom);});
mj->in.model_drivers.drivers_sens.upd_cb = [](){ model_drivers_drivers_sens_ptr->upd(mj->in.model_drivers.drivers_sens.ts_s, mj->in.model_drivers.drivers_sens.ts_ns);};
TreeNode * model_load_node = node->add("model_load",[](){return QVariant();});
model_load_node->isDev = true;
model_load_zu_im_data_ptr = node->lch()->add("zu_im_data",[](){return QVariant(mj->in.model_load.zu_im_data.msg->hdr.cnt);});
model_load_zu_im_data_ptr->state = []()->int32_t{return mj->in.model_load.zu_im_data.state;};
model_load_zu_im_data_ptr->msgId = ID_ZU_IM_DATA;
model_load_zu_im_data_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.model_load.zu_im_data.msg->hdr.ts_s)+static_cast<double>(mj->in.model_load.zu_im_data.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("current_vn",[](){return QVariant(mj->in.model_load.zu_im_data.msg->current_vn);});
node->lch()->lch()->add("current_gn",[](){return QVariant(mj->in.model_load.zu_im_data.msg->current_gn);});
node->lch()->lch()->add("angle_vn",[](){return QVariant(mj->in.model_load.zu_im_data.msg->angle_vn);});
node->lch()->lch()->add("angle_gn",[](){return QVariant(mj->in.model_load.zu_im_data.msg->angle_gn);});
node->lch()->lch()->add("vdc",[](){return QVariant(mj->in.model_load.zu_im_data.msg->vdc);});
node->lch()->lch()->add("angle_oeb",[](){return QVariant(mj->in.model_load.zu_im_data.msg->angle_oeb);});
node->lch()->lch()->add("gyro_data_gn",[](){return QVariant();});
node->lch()->lch()->lch()->add("velocity",[](){return QVariant();});
node->lch()->lch()->lch()->lch()->add("x",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_gn.velocity.x);});
node->lch()->lch()->lch()->lch()->add("y",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_gn.velocity.y);});
node->lch()->lch()->lch()->lch()->add("z",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_gn.velocity.z);});
node->lch()->lch()->lch()->add("acceleration",[](){return QVariant();});
node->lch()->lch()->lch()->lch()->add("x",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_gn.acceleration.x);});
node->lch()->lch()->lch()->lch()->add("y",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_gn.acceleration.y);});
node->lch()->lch()->lch()->lch()->add("z",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_gn.acceleration.z);});
node->lch()->lch()->lch()->add("temperature",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_gn.temperature);});
node->lch()->lch()->add("gyro_data_vn",[](){return QVariant();});
node->lch()->lch()->lch()->add("velocity",[](){return QVariant();});
node->lch()->lch()->lch()->lch()->add("x",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_vn.velocity.x);});
node->lch()->lch()->lch()->lch()->add("y",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_vn.velocity.y);});
node->lch()->lch()->lch()->lch()->add("z",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_vn.velocity.z);});
node->lch()->lch()->lch()->add("acceleration",[](){return QVariant();});
node->lch()->lch()->lch()->lch()->add("x",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_vn.acceleration.x);});
node->lch()->lch()->lch()->lch()->add("y",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_vn.acceleration.y);});
node->lch()->lch()->lch()->lch()->add("z",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_vn.acceleration.z);});
node->lch()->lch()->lch()->add("temperature",[](){return QVariant(mj->in.model_load.zu_im_data.msg->gyro_data_vn.temperature);});
mj->in.model_load.zu_im_data.upd_cb = [](){ model_load_zu_im_data_ptr->upd(mj->in.model_load.zu_im_data.ts_s, mj->in.model_load.zu_im_data.ts_ns);};
TreeNode * mon_node = node->add("mon",[](){return QVariant();});
mon_node->isDev = true;
mon_bup_srv_drv_ctrl_ptr = node->lch()->add("bup_srv_drv_ctrl",[](){return QVariant(mj->in.mon.bup_srv_drv_ctrl.msg->hdr.cnt);});
mon_bup_srv_drv_ctrl_ptr->state = []()->int32_t{return mj->in.mon.bup_srv_drv_ctrl.state;};
mon_bup_srv_drv_ctrl_ptr->msgId = ID_BUP_SRV_DRV_CTRL;
mon_bup_srv_drv_ctrl_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.mon.bup_srv_drv_ctrl.msg->hdr.ts_s)+static_cast<double>(mj->in.mon.bup_srv_drv_ctrl.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("az",[](){return QVariant();});
node->lch()->lch()->lch()->add("mode",[](){return QVariant((int32_t)(mj->in.mon.bup_srv_drv_ctrl.msg->az.mode));},[](){return (drv_ctrl_mode_str(mj->in.mon.bup_srv_drv_ctrl.msg->az.mode));});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.mon.bup_srv_drv_ctrl.msg->az.err);});
node->lch()->lch()->lch()->add("angle",[](){return QVariant(mj->in.mon.bup_srv_drv_ctrl.msg->az.angle);});
node->lch()->lch()->lch()->add("speed",[](){return QVariant(mj->in.mon.bup_srv_drv_ctrl.msg->az.speed);});
node->lch()->lch()->lch()->add("voltage",[](){return QVariant(mj->in.mon.bup_srv_drv_ctrl.msg->az.voltage);});
node->lch()->lch()->lch()->add("current",[](){return QVariant(mj->in.mon.bup_srv_drv_ctrl.msg->az.current);});
node->lch()->lch()->add("el",[](){return QVariant();});
node->lch()->lch()->lch()->add("mode",[](){return QVariant((int32_t)(mj->in.mon.bup_srv_drv_ctrl.msg->el.mode));},[](){return (drv_ctrl_mode_str(mj->in.mon.bup_srv_drv_ctrl.msg->el.mode));});
node->lch()->lch()->lch()->add("err",[](){return QVariant(mj->in.mon.bup_srv_drv_ctrl.msg->el.err);});
node->lch()->lch()->lch()->add("angle",[](){return QVariant(mj->in.mon.bup_srv_drv_ctrl.msg->el.angle);});
node->lch()->lch()->lch()->add("speed",[](){return QVariant(mj->in.mon.bup_srv_drv_ctrl.msg->el.speed);});
node->lch()->lch()->lch()->add("voltage",[](){return QVariant(mj->in.mon.bup_srv_drv_ctrl.msg->el.voltage);});
node->lch()->lch()->lch()->add("current",[](){return QVariant(mj->in.mon.bup_srv_drv_ctrl.msg->el.current);});
mj->in.mon.bup_srv_drv_ctrl.upd_cb = [](){ mon_bup_srv_drv_ctrl_ptr->upd(mj->in.mon.bup_srv_drv_ctrl.ts_s, mj->in.mon.bup_srv_drv_ctrl.ts_ns);};
...
pion_mku_gn_aim_ang_gn_sens_state_ptr = node->lch()->add("aim_ang_gn_sens_state",[](){return QVariant(mj->in.pion_mku_gn.aim_ang_gn_sens_state.msg->hdr.cnt);});
pion_mku_gn_aim_ang_gn_sens_state_ptr->state = []()->int32_t{return mj->in.pion_mku_gn.aim_ang_gn_sens_state.state;};
pion_mku_gn_aim_ang_gn_sens_state_ptr->msgId = ID_AIM_ANG_GN_SENS_STATE;
pion_mku_gn_aim_ang_gn_sens_state_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.pion_mku_gn.aim_ang_gn_sens_state.msg->hdr.ts_s)+static_cast<double>(mj->in.pion_mku_gn.aim_ang_gn_sens_state.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("angle",[](){return QVariant(mj->in.pion_mku_gn.aim_ang_gn_sens_state.msg->angle);});
node->lch()->lch()->add("status",[](){return QVariant((int32_t)(mj->in.pion_mku_gn.aim_ang_gn_sens_state.msg->status));},[](){return (ang_sens_status_str(mj->in.pion_mku_gn.aim_ang_gn_sens_state.msg->status));});
mj->in.pion_mku_gn.aim_ang_gn_sens_state.upd_cb = [](){ pion_mku_gn_aim_ang_gn_sens_state_ptr->upd(mj->in.pion_mku_gn.aim_ang_gn_sens_state.ts_s, mj->in.pion_mku_gn.aim_ang_gn_sens_state.ts_ns);};
TreeNode * wp_imu_node = node->add("wp_imu",[](){return QVariant();});
wp_imu_node->isDev = true;
wp_imu_wp_imu_state_ptr = node->lch()->add("wp_imu_state",[](){return QVariant(mj->in.wp_imu.wp_imu_state.msg->hdr.cnt);});
wp_imu_wp_imu_state_ptr->state = []()->int32_t{return mj->in.wp_imu.wp_imu_state.state;};
wp_imu_wp_imu_state_ptr->msgId = ID_WP_IMU_STATE;
wp_imu_wp_imu_state_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.wp_imu.wp_imu_state.msg->hdr.ts_s)+static_cast<double>(mj->in.wp_imu.wp_imu_state.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("omega",[](){return QVariant();});
node->lch()->lch()->lch()->add("x",[](){return QVariant(mj->in.wp_imu.wp_imu_state.msg->omega.x);});
node->lch()->lch()->lch()->add("y",[](){return QVariant(mj->in.wp_imu.wp_imu_state.msg->omega.y);});
node->lch()->lch()->lch()->add("z",[](){return QVariant(mj->in.wp_imu.wp_imu_state.msg->omega.z);});
node->lch()->lch()->add("a",[](){return QVariant();});
node->lch()->lch()->lch()->add("x",[](){return QVariant(mj->in.wp_imu.wp_imu_state.msg->a.x);});
node->lch()->lch()->lch()->add("y",[](){return QVariant(mj->in.wp_imu.wp_imu_state.msg->a.y);});
node->lch()->lch()->lch()->add("z",[](){return QVariant(mj->in.wp_imu.wp_imu_state.msg->a.z);});
node->lch()->lch()->add("temp",[](){return QVariant(mj->in.wp_imu.wp_imu_state.msg->temp);});
node->lch()->lch()->add("is_valid",[](){return QVariant(mj->in.wp_imu.wp_imu_state.msg->is_valid);});
mj->in.wp_imu.wp_imu_state.upd_cb = [](){ wp_imu_wp_imu_state_ptr->upd(mj->in.wp_imu.wp_imu_state.ts_s, mj->in.wp_imu.wp_imu_state.ts_ns);};
return node;
};


TreeNode * create_bup_dcu_gn_out_tree(mj_bup_dcu_gn_t * mj_ptr)
{
static mj_bup_dcu_gn_t * mj = mj_ptr;
TreeNode * node = new TreeNode("OUTPUT",[](){return QVariant();});
node->devIDs = devIDs;
node->devList = devList;
bup_drv_gn_state_ptr = node->add("bup_drv_gn_state",[](){return QVariant(mj->out.bup_drv_gn_state.msg->hdr.cnt);});
bup_drv_gn_state_ptr->tx = [](uint16_t dst){mj->out.bup_drv_gn_state.tx(dst);};

node->lch()->add("mode",[](){return QVariant((int32_t)(mj->out.bup_drv_gn_state.msg->mode));},[](){return (drv_ctrl_mode_str(mj->out.bup_drv_gn_state.msg->mode));})->setData =  [](QVariant data){ mj->out.bup_drv_gn_state.msg->mode=(int8_t)(data.value<int32_t>());return;};
...
node->lch()->add("error",[](){return QVariant((int32_t)(mj->out.bup_drv_gn_state.msg->error));},[](){return (drv_ctrl_error_str(mj->out.bup_drv_gn_state.msg->error));})->setData =  [](QVariant data){ mj->out.bup_drv_gn_state.msg->error=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
...
node->lch()->lch()->intval.append(14);
node->lch()->lch()->intval.append(15);
node->lch()->add("status",[](){return QVariant((int32_t)(mj->out.bup_drv_gn_state.msg->status));},[](){return (dcu_status_str(mj->out.bup_drv_gn_state.msg->status));})->setData =  [](QVariant data){ mj->out.bup_drv_gn_state.msg->status=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("OFF");
...
node->lch()->lch()->intval.append(5);
node->lch()->lch()->intval.append(-1);
node->lch()->add("limit",[](){return QVariant((int32_t)(mj->out.bup_drv_gn_state.msg->limit));},[](){return (move_limit_state_str(mj->out.bup_drv_gn_state.msg->limit));})->setData =  [](QVariant data){ mj->out.bup_drv_gn_state.msg->limit=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
...
node->lch()->lch()->intval.append(2);
node->lch()->lch()->intval.append(3);
node->lch()->add("angle",[](){return QVariant(mj->out.bup_drv_gn_state.msg->angle);})->setData =  [](QVariant data){ mj->out.bup_drv_gn_state.msg->angle=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("sync_delay_us",[](){return QVariant(mj->out.bup_drv_gn_state.msg->sync_delay_us);})->setData =  [](QVariant data){ mj->out.bup_drv_gn_state.msg->sync_delay_us=data.value<int32_t>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("transit_process",[](){return QVariant((int32_t)(mj->out.bup_drv_gn_state.msg->transit_process));},[](){return (transit_proc_status_str(mj->out.bup_drv_gn_state.msg->transit_process));})->setData =  [](QVariant data){ mj->out.bup_drv_gn_state.msg->transit_process=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOW");
node->lch()->lch()->values.append("NONE");
...
dcu_gn_state_ptr = node->add("dcu_gn_state",[](){return QVariant(mj->out.dcu_gn_state.msg->hdr.cnt);});
dcu_gn_state_ptr->tx_enable = &mj->out.dcu_gn_state.tx_enable;

node->lch()->add("mode",[](){return QVariant((int32_t)(mj->out.dcu_gn_state.msg->mode));},[](){return (drv_ctrl_mode_str(mj->out.dcu_gn_state.msg->mode));})->setData =  [](QVariant data){ mj->out.dcu_gn_state.msg->mode=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("OFF");
node->lch()->lch()->values.append("FREEMOVE");
...
node->lch()->lch()->intval.append(14);
node->lch()->lch()->intval.append(15);
node->lch()->add("error",[](){return QVariant((int32_t)(mj->out.dcu_gn_state.msg->error));},[](){return (drv_ctrl_error_str(mj->out.dcu_gn_state.msg->error));})->setData =  [](QVariant data){ mj->out.dcu_gn_state.msg->error=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("NONE");
node->lch()->lch()->values.append("BLOCK");
...
node->lch()->lch()->intval.append(14);
node->lch()->lch()->intval.append(15);
node->lch()->add("status",[](){return QVariant((int32_t)(mj->out.dcu_gn_state.msg->status));},[](){return (dcu_status_str(mj->out.dcu_gn_state.msg->status));})->setData =  [](QVariant data){ mj->out.dcu_gn_state.msg->status=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOWN");
node->lch()->lch()->values.append("OFF");
node->lch()->lch()->values.append("PREPARE");
...
node->lch()->lch()->intval.append(5);
node->lch()->lch()->intval.append(-1);
node->lch()->add("load_sens_state",[](){return QVariant((int32_t)(mj->out.dcu_gn_state.msg->load_sens_state));},[](){return (ang_sens_status_str(mj->out.dcu_gn_state.msg->load_sens_state));})->setData =  [](QVariant data){ mj->out.dcu_gn_state.msg->load_sens_state=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOW");
node->lch()->lch()->values.append("PREPARE");
...
node->lch()->lch()->intval.append(4);
node->lch()->lch()->intval.append(-1);
node->lch()->add("load_sens_angle",[](){return QVariant(mj->out.dcu_gn_state.msg->load_sens_angle);})->setData =  [](QVariant data){ mj->out.dcu_gn_state.msg->load_sens_angle=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("current",[](){return QVariant();});
node->lch()->lch()->add("a",[](){return QVariant(mj->out.dcu_gn_state.msg->current.a);})->setData =  [](QVariant data){ mj->out.dcu_gn_state.msg->current.a=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("b",[](){return QVariant(mj->out.dcu_gn_state.msg->current.b);})->setData =  [](QVariant data){ mj->out.dcu_gn_state.msg->current.b=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("c",[](){return QVariant(mj->out.dcu_gn_state.msg->current.c);})->setData =  [](QVariant data){ mj->out.dcu_gn_state.msg->current.c=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("rotor_sens_angle",[](){return QVariant(mj->out.dcu_gn_state.msg->rotor_sens_angle);})->setData =  [](QVariant data){ mj->out.dcu_gn_state.msg->rotor_sens_angle=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("power_vdc",[](){return QVariant(mj->out.dcu_gn_state.msg->power_vdc);})->setData =  [](QVariant data){ mj->out.dcu_gn_state.msg->power_vdc=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("rotor_sens_state",[](){return QVariant((int32_t)(mj->out.dcu_gn_state.msg->rotor_sens_state));},[](){return (ang_sens_status_str(mj->out.dcu_gn_state.msg->rotor_sens_state));})->setData =  [](QVariant data){ mj->out.dcu_gn_state.msg->rotor_sens_state=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOW");
node->lch()->lch()->values.append("PREPARE");
node->lch()->lch()->values.append("UNCONNECTED");
...
node->lch()->lch()->intval.append(14);
node->lch()->lch()->intval.append(15);
node->lch()->add("load_sens_state",[](){return QVariant((int32_t)(mj->out.dcu_tel.msg->load_sens_state));},[](){return (ang_sens_status_str(mj->out.dcu_tel.msg->load_sens_state));})->setData =  [](QVariant data){ mj->out.dcu_tel.msg->load_sens_state=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOW");
node->lch()->lch()->values.append("PREPARE");
node->lch()->lch()->values.append("UNCONNECTED");
...
node->lch()->lch()->lch()->editable = true;
node->lch()->add("gyro_angle",[](){return QVariant(mj->out.dcu_tel.msg->gyro_angle);})->setData =  [](QVariant data){ mj->out.dcu_tel.msg->gyro_angle=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("gyro_speed",[](){return QVariant(mj->out.dcu_tel.msg->gyro_speed);})->setData =  [](QVariant data){ mj->out.dcu_tel.msg->gyro_speed=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("gyro_bias",[](){return QVariant(mj->out.dcu_tel.msg->gyro_bias);})->setData =  [](QVariant data){ mj->out.dcu_tel.msg->gyro_bias=data.value<float>();return;};
node->lch()->lch()->editable = true;
...
node->lch()->lch()->editable = true;
node->lch()->add("rotor_sens_state",[](){return QVariant((int32_t)(mj->out.dcu_tel.msg->rotor_sens_state));},[](){return (ang_sens_status_str(mj->out.dcu_tel.msg->rotor_sens_state));})->setData =  [](QVariant data){ mj->out.dcu_tel.msg->rotor_sens_state=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOW");
node->lch()->lch()->values.append("PREPARE");
node->lch()->lch()->values.append("UNCONNECTED");
...
node->lch()->lch()->intval.append(4);
node->lch()->lch()->intval.append(-1);
node->lch()->add("transit_process",[](){return QVariant((int32_t)(mj->out.dcu_tel.msg->transit_process));},[](){return (transit_proc_status_str(mj->out.dcu_tel.msg->transit_process));})->setData =  [](QVariant data){ mj->out.dcu_tel.msg->transit_process=(int8_t)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOW");
node->lch()->lch()->values.append("NONE");
node->lch()->lch()->values.append("INPROGRESS");
...
izu_gn_drive_ctrl_ptr = node->add("izu_gn_drive_ctrl",[](){return QVariant(mj->out.izu_gn_drive_ctrl.msg->hdr.cnt);});
izu_gn_drive_ctrl_ptr->tx_enable = &mj->out.izu_gn_drive_ctrl.tx_enable;

node->lch()->add("voltage",[](){return QVariant();});
node->lch()->lch()->add("[0]",[](){return QVariant(mj->out.izu_gn_drive_ctrl.msg->voltage[0]);})->setData =  [](QVariant data){ mj->out.izu_gn_drive_ctrl.msg->voltage[0]=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("[1]",[](){return QVariant(mj->out.izu_gn_drive_ctrl.msg->voltage[1]);})->setData =  [](QVariant data){ mj->out.izu_gn_drive_ctrl.msg->voltage[1]=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("[2]",[](){return QVariant(mj->out.izu_gn_drive_ctrl.msg->voltage[2]);})->setData =  [](QVariant data){ mj->out.izu_gn_drive_ctrl.msg->voltage[2]=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("connected",[](){return QVariant(mj->out.izu_gn_drive_ctrl.msg->connected);})->setData =  [](QVariant data){ mj->out.izu_gn_drive_ctrl.msg->connected=data.value<bool>();return;};
node->lch()->lch()->editable = true;
...
wp_ang_gn_sens_state_ptr = node->add("wp_ang_gn_sens_state",[](){return QVariant(mj->out.wp_ang_gn_sens_state.msg->hdr.cnt);});
wp_ang_gn_sens_state_ptr->tx_enable = &mj->out.wp_ang_gn_sens_state.tx_enable;

node->lch()->add("angle",[](){return QVariant(mj->out.wp_ang_gn_sens_state.msg->angle);})->setData =  [](QVariant data){ mj->out.wp_ang_gn_sens_state.msg->angle=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("status",[](){return QVariant((int32_t)(mj->out.wp_ang_gn_sens_state.msg->status));},[](){return (ang_sens_status_str(mj->out.wp_ang_gn_sens_state.msg->status));})->setData =  [](QVariant data){ mj->out.wp_ang_gn_sens_state.msg->status=(ang_sens_status)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("UNKNOW");
node->lch()->lch()->values.append("PREPARE");
node->lch()->lch()->values.append("UNCONNECTED");
...
TreeNode * create_bup_dcu_gn_params_tree(mj_bup_dcu_gn_t * mj_ptr){
static mj_bup_dcu_gn_t * mj = mj_ptr;
...
node->lch()->add("val",[](){return QVariant(prm2QVariant(mj->out.prm_req.msg->id,(uint8_t*)mj->out.prm_req.msg->val,sizeof(mj->out.prm_req.msg->val)));})->setData =  [](QVariant data){ QVariant2prm(mj->out.prm_req.msg->id,(uint8_t*)mj->out.prm_req.msg->val,sizeof(mj->out.prm_req.msg->val),data);return;};
node->lch()->lch()->editable = true;
auto model_drivers_ptr = node->add("model_drivers",[](){return QVariant(mj->out.prm_req.msg->hdr.cnt);});
model_drivers_ptr->tx = [](uint16_t dst){mj->out.prm_req.tx(dst);};
node->lch()->add("type",[](){return QVariant((int32_t)(mj->out.prm_req.msg->type));})->setData =  [](QVariant data){ mj->out.prm_req.msg->type=(parameter_request_type)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("READ");
node->lch()->lch()->intval.append(0);
...
node->lch()->add("val",[](){return QVariant(prm2QVariant(mj->out.prm_req.msg->id,(uint8_t*)mj->out.prm_req.msg->val,sizeof(mj->out.prm_req.msg->val)));})->setData =  [](QVariant data){ QVariant2prm(mj->out.prm_req.msg->id,(uint8_t*)mj->out.prm_req.msg->val,sizeof(mj->out.prm_req.msg->val),data);return;};
node->lch()->lch()->editable = true;
auto wp_imu_ptr = node->add("wp_imu",[](){return QVariant(mj->out.prm_req.msg->hdr.cnt);});
wp_imu_ptr->tx = [](uint16_t dst){mj->out.prm_req.tx(dst);};
node->lch()->add("type",[](){return QVariant((int32_t)(mj->out.prm_req.msg->type));})->setData =  [](QVariant data){ mj->out.prm_req.msg->type=(parameter_request_type)(data.value<int32_t>());return;};
node->lch()->lch()->editable = true;
node->lch()->lch()->values.append("READ");
node->lch()->lch()->intval.append(0);

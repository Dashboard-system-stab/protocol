...
TreeNode * create_model_trig_in_tree(mj_model_trig_t * mj_ptr)
{
static mj_model_trig_t *mj = mj_ptr;
...
bup_tcu_trig_model_input_ptr = node->lch()->add("trig_model_input",[](){return QVariant(mj->in.bup_tcu.trig_model_input.msg->hdr.cnt);});
bup_tcu_trig_model_input_ptr->state = []()->int32_t{return mj->in.bup_tcu.trig_model_input.state;};
bup_tcu_trig_model_input_ptr->msgId = ID_TRIG_MODEL_INPUT;
bup_tcu_trig_model_input_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.bup_tcu.trig_model_input.msg->hdr.ts_s)+static_cast<double>(mj->in.bup_tcu.trig_model_input.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("va",[](){return QVariant(mj->in.bup_tcu.trig_model_input.msg->va);});
node->lch()->lch()->add("vb",[](){return QVariant(mj->in.bup_tcu.trig_model_input.msg->vb);});
node->lch()->lch()->add("vc",[](){return QVariant(mj->in.bup_tcu.trig_model_input.msg->vc);});
node->lch()->lch()->add("enbable",[](){return QVariant(mj->in.bup_tcu.trig_model_input.msg->enbable);});
mj->in.bup_tcu.trig_model_input.upd_cb = [](){ bup_tcu_trig_model_input_ptr->upd(mj->in.bup_tcu.trig_model_input.ts_s, mj->in.bup_tcu.trig_model_input.ts_ns);};
...
TreeNode * create_model_trig_out_tree(mj_model_trig_t * mj_ptr)
{
static mj_model_trig_t * mj = mj_ptr;
...
trig_model_state_ptr = node->add("trig_model_state",[](){return QVariant(mj->out.trig_model_state.msg->hdr.cnt);});
trig_model_state_ptr->tx_enable = &mj->out.trig_model_state.tx_enable;

node->lch()->add("ideal_ia",[](){return QVariant(mj->out.trig_model_state.msg->ideal_ia);})->setData =  [](QVariant data){ mj->out.trig_model_state.msg->ideal_ia=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("ideal_ib",[](){return QVariant(mj->out.trig_model_state.msg->ideal_ib);})->setData =  [](QVariant data){ mj->out.trig_model_state.msg->ideal_ib=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("ideal_ic",[](){return QVariant(mj->out.trig_model_state.msg->ideal_ic);})->setData =  [](QVariant data){ mj->out.trig_model_state.msg->ideal_ic=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("left_x",[](){return QVariant(mj->out.trig_model_state.msg->left_x);})->setData =  [](QVariant data){ mj->out.trig_model_state.msg->left_x=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("right_x",[](){return QVariant(mj->out.trig_model_state.msg->right_x);})->setData =  [](QVariant data){ mj->out.trig_model_state.msg->right_x=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("vdc",[](){return QVariant(mj->out.trig_model_state.msg->vdc);})->setData =  [](QVariant data){ mj->out.trig_model_state.msg->vdc=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("sens_ia",[](){return QVariant(mj->out.trig_model_state.msg->sens_ia);})->setData =  [](QVariant data){ mj->out.trig_model_state.msg->sens_ia=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("sens_ib",[](){return QVariant(mj->out.trig_model_state.msg->sens_ib);})->setData =  [](QVariant data){ mj->out.trig_model_state.msg->sens_ib=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("sens_ic",[](){return QVariant(mj->out.trig_model_state.msg->sens_ic);})->setData =  [](QVariant data){ mj->out.trig_model_state.msg->sens_ic=data.value<float>();return;};
node->lch()->lch()->editable = true;

return node;
};

TreeNode * create_model_trig_params_tree(mj_model_trig_t * mj_ptr){
static mj_model_trig_t * mj = mj_ptr;

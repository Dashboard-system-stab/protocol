...
TreeNode * create_bup_dcu_rrd_in_tree(mj_bup_dcu_rrd_t * mj_ptr)
{
static mj_bup_dcu_rrd_t *mj = mj_ptr;
...
TreeNode * create_bup_dcu_rrd_out_tree(mj_bup_dcu_rrd_t * mj_ptr)
{
static mj_bup_dcu_rrd_t * mj = mj_ptr;
...
TreeNode * create_bup_dcu_rrd_params_tree(mj_bup_dcu_rrd_t * mj_ptr){
static mj_bup_dcu_rrd_t * mj = mj_ptr;

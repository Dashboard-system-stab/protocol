...
static TreeNode *bup_dcu_gn_izu_gn_drive_ctrl_ptr = 0;
static TreeNode *bup_dcu_vn_izu_vn_drive_ctrl_ptr = 0;
static TreeNode *cvs_prm_req_ptr = 0;
static TreeNode *model_load_load_vels_ptr = 0;
static TreeNode *mon_izu_gn_drive_ctrl_ptr = 0;
static TreeNode *mon_izu_vn_drive_ctrl_ptr = 0;
static TreeNode *mon_prm_req_ptr = 0;

static TreeNode *dbg_ptr = 0;
static TreeNode *drivers_sens_ptr = 0;
static TreeNode *drivers_torques_ptr = 0;
...
TreeNode * create_model_drivers_in_tree(mj_model_drivers_t * mj_ptr)
{
static mj_model_drivers_t *mj = mj_ptr;
...
bup_dcu_gn_izu_gn_drive_ctrl_ptr = node->lch()->add("izu_gn_drive_ctrl",[](){return QVariant(mj->in.bup_dcu_gn.izu_gn_drive_ctrl.msg->hdr.cnt);});
bup_dcu_gn_izu_gn_drive_ctrl_ptr->state = []()->int32_t{return mj->in.bup_dcu_gn.izu_gn_drive_ctrl.state;};
bup_dcu_gn_izu_gn_drive_ctrl_ptr->msgId = ID_IZU_GN_DRIVE_CTRL;
bup_dcu_gn_izu_gn_drive_ctrl_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.bup_dcu_gn.izu_gn_drive_ctrl.msg->hdr.ts_s)+static_cast<double>(mj->in.bup_dcu_gn.izu_gn_drive_ctrl.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("voltage",[](){return QVariant();});
node->lch()->lch()->lch()->add("[0]",[](){return QVariant(mj->in.bup_dcu_gn.izu_gn_drive_ctrl.msg->voltage[0]);});
node->lch()->lch()->lch()->add("[1]",[](){return QVariant(mj->in.bup_dcu_gn.izu_gn_drive_ctrl.msg->voltage[1]);});
node->lch()->lch()->lch()->add("[2]",[](){return QVariant(mj->in.bup_dcu_gn.izu_gn_drive_ctrl.msg->voltage[2]);});
node->lch()->lch()->add("connected",[](){return QVariant(mj->in.bup_dcu_gn.izu_gn_drive_ctrl.msg->connected);});
mj->in.bup_dcu_gn.izu_gn_drive_ctrl.upd_cb = [](){ bup_dcu_gn_izu_gn_drive_ctrl_ptr->upd(mj->in.bup_dcu_gn.izu_gn_drive_ctrl.ts_s, mj->in.bup_dcu_gn.izu_gn_drive_ctrl.ts_ns);};
TreeNode * bup_dcu_vn_node = node->add("bup_dcu_vn",[](){return QVariant();});
bup_dcu_vn_node->isDev = true;
bup_dcu_vn_izu_vn_drive_ctrl_ptr = node->lch()->add("izu_vn_drive_ctrl",[](){return QVariant(mj->in.bup_dcu_vn.izu_vn_drive_ctrl.msg->hdr.cnt);});
bup_dcu_vn_izu_vn_drive_ctrl_ptr->state = []()->int32_t{return mj->in.bup_dcu_vn.izu_vn_drive_ctrl.state;};
bup_dcu_vn_izu_vn_drive_ctrl_ptr->msgId = ID_IZU_VN_DRIVE_CTRL;
bup_dcu_vn_izu_vn_drive_ctrl_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.bup_dcu_vn.izu_vn_drive_ctrl.msg->hdr.ts_s)+static_cast<double>(mj->in.bup_dcu_vn.izu_vn_drive_ctrl.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("voltage",[](){return QVariant();});
node->lch()->lch()->lch()->add("[0]",[](){return QVariant(mj->in.bup_dcu_vn.izu_vn_drive_ctrl.msg->voltage[0]);});
node->lch()->lch()->lch()->add("[1]",[](){return QVariant(mj->in.bup_dcu_vn.izu_vn_drive_ctrl.msg->voltage[1]);});
node->lch()->lch()->lch()->add("[2]",[](){return QVariant(mj->in.bup_dcu_vn.izu_vn_drive_ctrl.msg->voltage[2]);});
node->lch()->lch()->add("connected",[](){return QVariant(mj->in.bup_dcu_vn.izu_vn_drive_ctrl.msg->connected);});
mj->in.bup_dcu_vn.izu_vn_drive_ctrl.upd_cb = [](){ bup_dcu_vn_izu_vn_drive_ctrl_ptr->upd(mj->in.bup_dcu_vn.izu_vn_drive_ctrl.ts_s, mj->in.bup_dcu_vn.izu_vn_drive_ctrl.ts_ns);};
...
model_load_load_vels_ptr = node->lch()->add("load_vels",[](){return QVariant(mj->in.model_load.load_vels.msg->hdr.cnt);});
model_load_load_vels_ptr->state = []()->int32_t{return mj->in.model_load.load_vels.state;};
model_load_load_vels_ptr->msgId = ID_LOAD_VELS;
model_load_load_vels_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.model_load.load_vels.msg->hdr.ts_s)+static_cast<double>(mj->in.model_load.load_vels.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("vel_gn",[](){return QVariant(mj->in.model_load.load_vels.msg->vel_gn);});
node->lch()->lch()->add("vel_vn",[](){return QVariant(mj->in.model_load.load_vels.msg->vel_vn);});
mj->in.model_load.load_vels.upd_cb = [](){ model_load_load_vels_ptr->upd(mj->in.model_load.load_vels.ts_s, mj->in.model_load.load_vels.ts_ns);};
TreeNode * mon_node = node->add("mon",[](){return QVariant();});
mon_node->isDev = true;
mon_izu_gn_drive_ctrl_ptr = node->lch()->add("izu_gn_drive_ctrl",[](){return QVariant(mj->in.mon.izu_gn_drive_ctrl.msg->hdr.cnt);});
mon_izu_gn_drive_ctrl_ptr->state = []()->int32_t{return mj->in.mon.izu_gn_drive_ctrl.state;};
mon_izu_gn_drive_ctrl_ptr->msgId = ID_IZU_GN_DRIVE_CTRL;
mon_izu_gn_drive_ctrl_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.mon.izu_gn_drive_ctrl.msg->hdr.ts_s)+static_cast<double>(mj->in.mon.izu_gn_drive_ctrl.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("voltage",[](){return QVariant();});
node->lch()->lch()->lch()->add("[0]",[](){return QVariant(mj->in.mon.izu_gn_drive_ctrl.msg->voltage[0]);});
node->lch()->lch()->lch()->add("[1]",[](){return QVariant(mj->in.mon.izu_gn_drive_ctrl.msg->voltage[1]);});
node->lch()->lch()->lch()->add("[2]",[](){return QVariant(mj->in.mon.izu_gn_drive_ctrl.msg->voltage[2]);});
node->lch()->lch()->add("connected",[](){return QVariant(mj->in.mon.izu_gn_drive_ctrl.msg->connected);});
mj->in.mon.izu_gn_drive_ctrl.upd_cb = [](){ mon_izu_gn_drive_ctrl_ptr->upd(mj->in.mon.izu_gn_drive_ctrl.ts_s, mj->in.mon.izu_gn_drive_ctrl.ts_ns);};
mon_izu_vn_drive_ctrl_ptr = node->lch()->add("izu_vn_drive_ctrl",[](){return QVariant(mj->in.mon.izu_vn_drive_ctrl.msg->hdr.cnt);});
mon_izu_vn_drive_ctrl_ptr->state = []()->int32_t{return mj->in.mon.izu_vn_drive_ctrl.state;};
mon_izu_vn_drive_ctrl_ptr->msgId = ID_IZU_VN_DRIVE_CTRL;
mon_izu_vn_drive_ctrl_ptr->add("time",[](){return QVariant(static_cast<double>(mj->in.mon.izu_vn_drive_ctrl.msg->hdr.ts_s)+static_cast<double>(mj->in.mon.izu_vn_drive_ctrl.msg->hdr.ts_ns)/1e9);});

node->lch()->lch()->add("voltage",[](){return QVariant();});
node->lch()->lch()->lch()->add("[0]",[](){return QVariant(mj->in.mon.izu_vn_drive_ctrl.msg->voltage[0]);});
node->lch()->lch()->lch()->add("[1]",[](){return QVariant(mj->in.mon.izu_vn_drive_ctrl.msg->voltage[1]);});
node->lch()->lch()->lch()->add("[2]",[](){return QVariant(mj->in.mon.izu_vn_drive_ctrl.msg->voltage[2]);});
node->lch()->lch()->add("connected",[](){return QVariant(mj->in.mon.izu_vn_drive_ctrl.msg->connected);});
mj->in.mon.izu_vn_drive_ctrl.upd_cb = [](){ mon_izu_vn_drive_ctrl_ptr->upd(mj->in.mon.izu_vn_drive_ctrl.ts_s, mj->in.mon.izu_vn_drive_ctrl.ts_ns);};
...
TreeNode * create_model_drivers_out_tree(mj_model_drivers_t * mj_ptr)
{
static mj_model_drivers_t * mj = mj_ptr;
...
drivers_sens_ptr = node->add("drivers_sens",[](){return QVariant(mj->out.drivers_sens.msg->hdr.cnt);});
drivers_sens_ptr->tx_enable = &mj->out.drivers_sens.tx_enable;

node->lch()->add("currents_gn",[](){return QVariant();});
node->lch()->lch()->add("[0]",[](){return QVariant(mj->out.drivers_sens.msg->currents_gn[0]);})->setData =  [](QVariant data){ mj->out.drivers_sens.msg->currents_gn[0]=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("[1]",[](){return QVariant(mj->out.drivers_sens.msg->currents_gn[1]);})->setData =  [](QVariant data){ mj->out.drivers_sens.msg->currents_gn[1]=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("[2]",[](){return QVariant(mj->out.drivers_sens.msg->currents_gn[2]);})->setData =  [](QVariant data){ mj->out.drivers_sens.msg->currents_gn[2]=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("currents_vn",[](){return QVariant();});
node->lch()->lch()->add("[0]",[](){return QVariant(mj->out.drivers_sens.msg->currents_vn[0]);})->setData =  [](QVariant data){ mj->out.drivers_sens.msg->currents_vn[0]=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("[1]",[](){return QVariant(mj->out.drivers_sens.msg->currents_vn[1]);})->setData =  [](QVariant data){ mj->out.drivers_sens.msg->currents_vn[1]=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("[2]",[](){return QVariant(mj->out.drivers_sens.msg->currents_vn[2]);})->setData =  [](QVariant data){ mj->out.drivers_sens.msg->currents_vn[2]=data.value<float>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->add("rotor_angle_gn",[](){return QVariant(mj->out.drivers_sens.msg->rotor_angle_gn);})->setData =  [](QVariant data){ mj->out.drivers_sens.msg->rotor_angle_gn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("rotor_angle_vn",[](){return QVariant(mj->out.drivers_sens.msg->rotor_angle_vn);})->setData =  [](QVariant data){ mj->out.drivers_sens.msg->rotor_angle_vn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("v_nom",[](){return QVariant(mj->out.drivers_sens.msg->v_nom);})->setData =  [](QVariant data){ mj->out.drivers_sens.msg->v_nom=data.value<float>();return;};
node->lch()->lch()->editable = true;

drivers_torques_ptr = node->add("drivers_torques",[](){return QVariant(mj->out.drivers_torques.msg->hdr.cnt);});
drivers_torques_ptr->tx_enable = &mj->out.drivers_torques.tx_enable;

node->lch()->add("torque_gn",[](){return QVariant(mj->out.drivers_torques.msg->torque_gn);})->setData =  [](QVariant data){ mj->out.drivers_torques.msg->torque_gn=data.value<float>();return;};
node->lch()->lch()->editable = true;
node->lch()->add("torque_vn",[](){return QVariant(mj->out.drivers_torques.msg->torque_vn);})->setData =  [](QVariant data){ mj->out.drivers_torques.msg->torque_vn=data.value<float>();return;};
node->lch()->lch()->editable = true;
...
TreeNode * create_model_drivers_params_tree(mj_model_drivers_t * mj_ptr){
static mj_model_drivers_t * mj = mj_ptr;

...
static TreeNode *drive_master_ctrl_ptr = 0;
static TreeNode *drive_slave_fb_ptr = 0;
...
node->lch()->lch()->intval.append(-1);
node->lch()->lch()->intval.append(-2);
node->lch()->add("hall",[](){return QVariant();});
node->lch()->lch()->add("a",[](){return QVariant(mj->out.dcu_tel.msg->hall.a);})->setData =  [](QVariant data){ mj->out.dcu_tel.msg->hall.a=data.value<bool>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("b",[](){return QVariant(mj->out.dcu_tel.msg->hall.b);})->setData =  [](QVariant data){ mj->out.dcu_tel.msg->hall.b=data.value<bool>();return;};
node->lch()->lch()->lch()->editable = true;
node->lch()->lch()->add("c",[](){return QVariant(mj->out.dcu_tel.msg->hall.c);})->setData =  [](QVariant data){ mj->out.dcu_tel.msg->hall.c=data.value<bool>();return;};
node->lch()->lch()->lch()->editable = true;

drive_master_ctrl_ptr = node->add("drive_master_ctrl",[](){return QVariant(mj->out.drive_master_ctrl.msg->hdr.cnt);});
drive_master_ctrl_ptr->tx_enable = &mj->out.drive_master_ctrl.tx_enable;

node->lch()->add("current",[](){return QVariant(mj->out.drive_master_ctrl.msg->current);})->setData =  [](QVariant data){ mj->out.drive_master_ctrl.msg->current=data.value<float>();return;};
node->lch()->lch()->editable = true;

drive_slave_fb_ptr = node->add("drive_slave_fb",[](){return QVariant(mj->out.drive_slave_fb.msg->hdr.cnt);});
drive_slave_fb_ptr->tx_enable = &mj->out.drive_slave_fb.tx_enable;

node->lch()->add("rotor_speed",[](){return QVariant(mj->out.drive_slave_fb.msg->rotor_speed);})->setData =  [](QVariant data){ mj->out.drive_slave_fb.msg->rotor_speed=data.value<float>();return;};
node->lch()->lch()->editable = true;

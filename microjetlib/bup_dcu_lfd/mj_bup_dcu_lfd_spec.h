#ifndef BUP_DCU_LFD_DEV_SPEC_H
#define BUP_DCU_LFD_DEV_SPEC_H
...
typedef struct bup_dcu_lfd_prm{
     /** dev_id [-] */
     int dev_id;
...
typedef struct mj_bup_dcu_lfd
{
     /** bup_dcu_lfd input messages */
     struct
     {
     ...
     /** bup_dcu_lfd parameters */
     struct
     {
          bup_dcu_lfd_prm_t *ptr;

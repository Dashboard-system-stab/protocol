...
mj_prm_status_t bup_dcu_lst_prm_write(int id, void *data)
{
    switch (id){
        ...
        case PRM_FLOAT_LOAD_SPEED_KB:
            memcpy(&(_bup_dcu_lst_prm.load_speed_kb),data,sizeof(_bup_dcu_lst_prm.load_speed_kb));
            return MJ_PRM_OK;
        ...
        case PRM_FLOAT_ROTOR_SPEED_KB:
            memcpy(&(_bup_dcu_lst_prm.rotor_speed_kb),data,sizeof(_bup_dcu_lst_prm.rotor_speed_kb));
            return MJ_PRM_OK;
        ...
        case PRM_FLOAT_ROTOR_ANG_KB:
            memcpy(&(_bup_dcu_lst_prm.rotor_ang_kb),data,sizeof(_bup_dcu_lst_prm.rotor_ang_kb));
            return MJ_PRM_OK;
...
mj_prm_status_t bup_dcu_lst_prm_read(int id, void *data)
{
    switch (id){
        ...
        case PRM_FLOAT_LOAD_SPEED_KI:
            ...
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_KB:
            memcpy(data,&_bup_dcu_lst_prm.load_speed_kb,sizeof(_bup_dcu_lst_prm.load_speed_kb));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_KT:
        ...
        case PRM_FLOAT_ROTOR_SPEED_KI:
            ...
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_KB:
            memcpy(data,&_bup_dcu_lst_prm.rotor_speed_kb,sizeof(_bup_dcu_lst_prm.rotor_speed_kb));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_KT:
        ...
        case PRM_FLOAT_ROTOR_ANG_KI:
            ...
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_KB:
            memcpy(data,&_bup_dcu_lst_prm.rotor_ang_kb,sizeof(_bup_dcu_lst_prm.rotor_ang_kb));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_KT:
...
mj_status_t mj_bup_dcu_lst_prm_init(mj_bup_dcu_lst_t ** ptr){
    ...
    _bup_dcu_lst_prm.load_speed_kb = 0.0;

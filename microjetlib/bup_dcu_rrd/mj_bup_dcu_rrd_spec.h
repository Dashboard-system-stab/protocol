#ifndef BUP_DCU_RRD_DEV_SPEC_H
#define BUP_DCU_RRD_DEV_SPEC_H
...
typedef struct bup_dcu_rrd_prm{
     /** dev_id [-] */
     int dev_id;
...
typedef struct mj_bup_dcu_rrd
{
     /** bup_dcu_rrd input messages */
     struct
     {
     ...
     /** bup_dcu_rrd parameters */
     struct
     {
          bup_dcu_rrd_prm_t *ptr;

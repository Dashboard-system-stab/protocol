...
mj_prm_status_t bup_dcu_rst_prm_write(int id, void *data)
{
    switch (id){
        ...
        case PRM_FLOAT_LOAD_SPEED_KD:
            memcpy(&(_bup_dcu_rst_prm.load_speed_kd),data,sizeof(_bup_dcu_rst_prm.load_speed_kd));
            return MJ_PRM_OK;
        ...
        case PRM_FLOAT_ROTOR_SPEED_KD:
            memcpy(&(_bup_dcu_rst_prm.rotor_speed_kd),data,sizeof(_bup_dcu_rst_prm.rotor_speed_kd));
            return MJ_PRM_OK;
        ...
        case PRM_FLOAT_ROTOR_ANG_KD:
            memcpy(&(_bup_dcu_rst_prm.rotor_ang_kd),data,sizeof(_bup_dcu_rst_prm.rotor_ang_kd));
            return MJ_PRM_OK;
        ...
        case PRM_STRING_COM_IF_IM_BRO_DRIVE_CTRL_MCAST:
            memcpy(&(_bup_dcu_rst_prm.com_if_im_bro_drive_ctrl_mcast),data,sizeof(_bup_dcu_rst_prm.com_if_im_bro_drive_ctrl_mcast));
            return MJ_PRM_OK;
        default:
...
mj_prm_status_t bup_dcu_rst_prm_read(int id, void *data)
{
    switch (id){
        ...
        case PRM_FLOAT_LOAD_SPEED_KI:
            ...
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_KD:
            memcpy(data,&_bup_dcu_rst_prm.load_speed_kd,sizeof(_bup_dcu_rst_prm.load_speed_kd));
            return MJ_PRM_OK;
        case PRM_FLOAT_LOAD_SPEED_KT:
        ...
        case PRM_FLOAT_ROTOR_SPEED_KI:
            ...
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_KD:
            memcpy(data,&_bup_dcu_rst_prm.rotor_speed_kd,sizeof(_bup_dcu_rst_prm.rotor_speed_kd));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_SPEED_KT:
        ...
        case PRM_FLOAT_ROTOR_ANG_KI:
            ...
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_KD:
            memcpy(data,&_bup_dcu_rst_prm.rotor_ang_kd,sizeof(_bup_dcu_rst_prm.rotor_ang_kd));
            return MJ_PRM_OK;
        case PRM_FLOAT_ROTOR_ANG_KT:
        ...
        case PRM_STRING_COM_IF_IM_BRO_DRIVE_MCAST:
            ...
            return MJ_PRM_OK;
        case PRM_STRING_COM_IF_IM_BRO_DRIVE_CTRL_MCAST:
            memcpy(data,&_bup_dcu_rst_prm.com_if_im_bro_drive_ctrl_mcast,sizeof(_bup_dcu_rst_prm.com_if_im_bro_drive_ctrl_mcast));
            return MJ_PRM_OK;
        default:
            return MJ_PRM_UNKNOW;
    }
...
mj_status_t mj_bup_dcu_rst_prm_init(mj_bup_dcu_rst_t ** ptr){
    ...
    memcpy(&(_bup_dcu_rst_prm.com_if_im_bro_drive_ctrl_mcast), default_com_if_im_bro_drive_ctrl_mcast, sizeof(default_com_if_im_bro_drive_ctrl_mcast) > 32 ? 32 : sizeof(default_com_if_im_bro_drive_ctrl_mcast));
    ...
    _bup_dcu_rst_prm.load_speed_kd = 0.0;
    ...
    _bup_dcu_rst_prm.rotor_speed_kd = 0.0;
    ...
    _bup_dcu_rst_prm.rotor_ang_kd = 0.0;

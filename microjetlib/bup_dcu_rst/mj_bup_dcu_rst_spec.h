#ifndef BUP_DCU_RST_DEV_SPEC_H
#define BUP_DCU_RST_DEV_SPEC_H
...
typedef struct bup_dcu_rst_prm{
     /** dev_id [-] */
     int dev_id;
...
typedef struct mj_bup_dcu_rst
{
     /** bup_dcu_rst input messages */
     struct
     {
     ...
     /** bup_dcu_rst parameters */
     struct
     {
          bup_dcu_rst_prm_t *ptr;
